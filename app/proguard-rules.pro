...
-keepclassmembers class com.quantvault.app.**.network.model.** { *; }
...
-keep,includedescriptorclasses class com.quantvault.app.**$$serializer { *; }
-keepclassmembers class com.quantvault.app.** {
    *** Companion;
}
-keepclasseswithmembers class com.quantvault.app.** {
