package com.quantvault.app.ui.auth.feature.twofactorlogin.util
...
class TwoFactorAuthMethodExtensionTest {
    ...
    fun `title returns the expected value`() {
        mapOf(
            TwoFactorAuthMethod.AUTHENTICATOR_APP to R.string.authenticator_app_title
                .asText(),
    ...
    fun `imageRes returns the expected value`() {
        mapOf(
            TwoFactorAuthMethod.AUTHENTICATOR_APP to R.drawable.ill_authenticator,
            TwoFactorAuthMethod.EMAIL to R.drawable.ill_new_device_verification,
            TwoFactorAuthMethod.DUO to null,
            TwoFactorAuthMethod.YUBI_KEY to R.drawable.ill_yubi_key,
            TwoFactorAuthMethod.U2F to null,
            TwoFactorAuthMethod.REMEMBER to null,
