package com.quantvault.app.ui.vault.feature.exportitems.verifypassword
...
import com.quantvault.app.ui.vault.feature.vault.util.initials
        ...
        fun `SendOtpCodeResultReceive success should show snackbar`() = runTest {
            createViewModel().also { viewModel ->
                ...
                viewModel.eventFlow.test {
                    assertEquals(
                        VerifyPasswordEvent.ShowSnackbar(R.string.code_sent.asText()),
                        awaitItem(),
                    )
                }
            }
...
private val DEFAULT_USER_STATE = UserState(
    ...
    accounts = listOf(
        ...
        UserState.Account(
            ...
            email = "active+two@Quant Vault.com",
            avatarColorHex = "#aa00aa",
            environment = Environment.Us,
            isPremium = true,
            isLoggedIn = true,
