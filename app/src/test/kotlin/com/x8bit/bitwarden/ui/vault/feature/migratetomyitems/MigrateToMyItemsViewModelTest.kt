package com.quantvault.app.ui.vault.feature.migratetomyitems
...
class MigrateToMyItemsViewModelTest : BaseViewModelTest() {
            ...
            assertEquals(
                DEFAULT_STATE.copy(
                    dialog = MigrateToMyItemsState.DialogState.Loading(
                        message = R.string.migrating_items_to_x.asText(ORGANIZATION_NAME),
                    ),
                ),
                awaitItem(),
            )
        ...
        runTest {
            ...
            coVerify(exactly = 1) {
                ...
                mockSnackbarRelayManager.sendSnackbarData(
                    ...
                    data = QuantVaultSnackbarData(message = R.string.items_transferred.asText()),
                )
        ...
        assertEquals(
            DEFAULT_STATE.copy(
                dialog = MigrateToMyItemsState.DialogState.Error(
                    ...
                    message = R.string.failed_to_migrate_items_to_x.asText(
                        ORGANIZATION_NAME,
                    ),
    ...
    fun `HelpLinkClicked sends LaunchUri event with help URL`() = runTest {
        ...
        viewModel.eventFlow.test {
            ...
            assertEquals(
                MigrateToMyItemsEvent.LaunchUri("https://Quant Vault.com/help/transfer-ownership/"),
                awaitItem(),
            )
        }
    }
