package com.quantvault.app.ui.autofill
...
import com.quantvault.app.ui.autofill.util.isSystemDarkMode
...
class quantvaultRemoteViewsTest {
    ...
    fun `buildVaultItemAutofillRemoteViews should set values properly when vault is locked`() {
        ...
        verify(exactly = 1) {
            ...
            anyConstructed<RemoteViews>()
                .setImageViewResource(
                    R.id.icon,
                    R.drawable.logo_Quant Vault_icon,
                )
            anyConstructed<RemoteViews>()
                .setInt(
                    R.id.container,
...
private const val APP_NAME = "Quant Vault"
