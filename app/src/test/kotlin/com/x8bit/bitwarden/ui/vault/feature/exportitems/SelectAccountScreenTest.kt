package com.quantvault.app.ui.vault.feature.exportitems
...
import com.quantvault.app.ui.vault.feature.exportitems.model.AccountSelectionListItem
import com.quantvault.app.ui.vault.feature.exportitems.selectaccount.SelectAccountAction
import com.quantvault.app.ui.vault.feature.exportitems.selectaccount.SelectAccountEvent
import com.quantvault.app.ui.vault.feature.exportitems.selectaccount.SelectAccountScreen
import com.quantvault.app.ui.vault.feature.exportitems.selectaccount.SelectAccountState
import com.quantvault.app.ui.vault.feature.exportitems.selectaccount.SelectAccountViewModel
...
class SelectAccountScreenTest : QuantVaultComposeTest() {
    ...
    fun `NoItemsContent should be displayed according to state`() = runTest {
        ...
        val text = "You don’t have any accounts you can import from. Your organization’s " +
            "security policy may restrict importing items from Quant Vault to another app."
        composeTestRule
