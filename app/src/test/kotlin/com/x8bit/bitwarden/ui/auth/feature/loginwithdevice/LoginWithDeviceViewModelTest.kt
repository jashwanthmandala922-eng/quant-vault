package com.quantvault.app.ui.auth.feature.loginwithdevice
...
import com.quantvault.app.ui.auth.feature.loginwithdevice.model.LoginWithDeviceType
        ...
        assertEquals(
            DEFAULT_STATE.copy(
                dialogState = LoginWithDeviceState.DialogState.Loading(
                    message = R.string.resending.asText(),
                ),
            ),
            viewModel.stateFlow.value,
        )
