...
import com.quantvault.app.ui.auth.feature.environment.EnvironmentState.DialogState
...
class EnvironmentScreenTest : QuantVaultComposeTest() {
    ...
    fun `server URL should change according to the state`() {
        composeTestRule
            ...
            .performClick()
            .assertTextEquals("Server URL", "ex. https://Quant Vault.company.com", "")
