...
import com.quantvault.core.data.manager.util.deviceData
...
import com.quantvault.app.ui.platform.feature.settings.about.util.getStopsLoggingStringForActiveLog
...
private val DEFAULT_ABOUT_STATE: AboutState = AboutState(
    ...
    copyrightInfo = "© Quant Vault Inc. 2015-${Year.now(FIXED_CLOCK).value}".asText(),
