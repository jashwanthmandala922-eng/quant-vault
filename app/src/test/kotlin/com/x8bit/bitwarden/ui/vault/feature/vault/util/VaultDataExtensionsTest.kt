...
import com.quantvault.app.data.vault.repository.util.toFailureCipherListView
import com.quantvault.app.ui.vault.feature.itemlisting.model.ListingItemOverflowAction
import com.quantvault.app.ui.vault.feature.util.toLabelIcons
import com.quantvault.app.ui.vault.feature.util.toOverflowActions
import com.quantvault.app.ui.vault.feature.vault.VaultState
...
class VaultDataExtensionsTest {
            ...
            VaultState.ViewState.Content(
                ...
                favoriteItems = listOf(
                    VaultState.ViewState.VaultItem.Login(
                        id = "mockId-2",
                        name = R.string.error_cannot_decrypt.asText(),
                        startIcon = IconData.Local(iconRes = R.drawable.ic_globe),
    ...
    fun `toLoginIconData should return IconData Network type if isIconLoadingDisabled is false`() {
        ...
        val expected = IconData.Network(
            uri = "https://icons.Quant Vault.net/www.mockuri1.com/icon.png",
