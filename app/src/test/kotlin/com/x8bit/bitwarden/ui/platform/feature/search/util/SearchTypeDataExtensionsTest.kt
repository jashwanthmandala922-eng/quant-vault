package com.quantvault.app.ui.platform.feature.search.util
...
import com.quantvault.app.ui.platform.feature.search.SearchState
import com.quantvault.app.ui.platform.feature.search.SearchTypeData
...
class SearchTypeDataExtensionsTest {
    ...
    fun `CipherViews toViewState should return content state when search term is not blank and ciphers is not empty`() {
        ...
        val result = sends.toViewState(
            searchTerm = "mock",
            baseIconUrl = "https://vault.Quant Vault.com/icons",
            isIconLoadingDisabled = false,
            isAutofill = false,
            hasMasterPassword = true,
            isPremiumUser = true,
    ...
    fun `SendViews toViewState should return content state when search term is not blank and sends is not empty`() {
        mockkStatic(TemporalAccessor::toFormattedDateTimeStyle) {
            ...
            val result = sends.toViewState(
                searchTerm = "mock",
                baseWebSendUrl = "https://vault.Quant Vault.com/#/send/",
                clock = clock,
            )
