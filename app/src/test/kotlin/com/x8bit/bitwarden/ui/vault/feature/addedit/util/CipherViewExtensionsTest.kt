...
import com.quantvault.vault.CardView
...
import com.quantvault.vault.FieldView
import com.quantvault.vault.IdentityView
...
import com.quantvault.vault.SecureNoteView
import com.quantvault.vault.SshKeyView
...
import com.quantvault.app.ui.vault.feature.addedit.VaultAddEditState
        ...
        assertEquals(
            VaultAddEditState.ViewState.Content(
                common = VaultAddEditState.ViewState.Content.Common(
                    ...
                    availableFolders = emptyList(),
                    availableOwners = emptyList(),
                    archiveCalloutText = R.string.this_item_is_archived.asText(),
                ),
                isIndividualVaultDisabled = false,
                type = VaultAddEditState.ViewState.Content.ItemType.SecureNotes,
            ),
        ...
        assertEquals(
            VaultAddEditState.ViewState.Content(
                common = VaultAddEditState.ViewState.Content.Common(
                    ...
                    availableFolders = emptyList(),
                    availableOwners = emptyList(),
                    archiveCalloutText = R.string.this_item_is_archived_saving_changes_will_restore_it_to_your_vault
                        .asText(),
                ),
                isIndividualVaultDisabled = false,
                type = VaultAddEditState.ViewState.Content.ItemType.SecureNotes,
