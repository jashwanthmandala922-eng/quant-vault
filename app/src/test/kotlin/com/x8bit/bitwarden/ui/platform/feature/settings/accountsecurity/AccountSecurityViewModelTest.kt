package com.quantvault.app.ui.platform.feature.settings.accountsecurity
...
import com.quantvault.network.model.SyncResponseJson.Policy
...
import com.quantvault.app.ui.platform.components.toggle.UnlockWithPinState
import com.quantvault.app.ui.platform.feature.settings.accountsecurity.AccountSecurityAction.AuthenticatorSyncToggle
...
class AccountSecurityViewModelTest : BaseViewModelTest() {
            ...
            viewModel.eventFlow.test {
                ...
                assertEquals(
                    AccountSecurityEvent.NavigateToChangeMasterPassword(
                        "https://vault.Quant Vault.com/#/settings",
                    ),
                    awaitItem(),
                )
                ...
                assertEquals(
                    AccountSecurityEvent.NavigateToChangeMasterPassword(
                        "https://vault.Quant Vault.eu/#/settings",
                    ),
                    awaitItem(),
                )
            }
    ...
    fun `on EnableBiometricsClick should show Error dialog when cipher is null`() {
        every { authRepository.createCipherOrNull(DEFAULT_USER_STATE.activeUserId) } returns null
        val viewModel = createViewModel()
