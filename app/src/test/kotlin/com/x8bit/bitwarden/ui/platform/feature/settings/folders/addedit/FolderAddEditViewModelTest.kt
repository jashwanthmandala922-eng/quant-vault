package com.quantvault.app.ui.platform.feature.settings.folders.addedit
...
import com.quantvault.app.ui.platform.feature.settings.folders.model.FolderAddEditType
...
class FolderAddEditViewModelTest : BaseViewModelTest() {
        ...
        runTest {
            ...
            verify(exactly = 1) {
                relayManager.sendSnackbarData(
                    data = QuantVaultSnackbarData(R.string.folder_deleted.asText()),
    ...
    fun `in add mode, SaveClick createFolder success should show dialog, and remove it once an item is saved`() =
        runTest {
            ...
            verify(exactly = 1) {
                relayManager.sendSnackbarData(
                    data = QuantVaultSnackbarData(R.string.folder_created.asText()),
    ...
    fun `in edit mode, SaveClick should show dialog, and remove it once an item is saved`() =
        runTest {
            ...
            verify(exactly = 1) {
                relayManager.sendSnackbarData(
                    data = QuantVaultSnackbarData(R.string.folder_updated.asText()),
