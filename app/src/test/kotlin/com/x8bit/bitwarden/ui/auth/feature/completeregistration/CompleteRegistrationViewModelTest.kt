package com.quantvault.app.ui.auth.feature.completeregistration
...
import com.quantvault.app.data.platform.manager.model.SpecialCircumstance.RegistrationEvent
...
import com.quantvault.app.ui.auth.feature.completeregistration.CompleteRegistrationAction.BackClick
import com.quantvault.app.ui.auth.feature.completeregistration.CompleteRegistrationAction.ConfirmPasswordInputChange
import com.quantvault.app.ui.auth.feature.completeregistration.CompleteRegistrationAction.Internal.ReceivePasswordStrengthResult
import com.quantvault.app.ui.auth.feature.completeregistration.CompleteRegistrationAction.PasswordHintChange
import com.quantvault.app.ui.auth.feature.completeregistration.CompleteRegistrationAction.PasswordInputChange
...
class CompleteRegistrationViewModelTest : BaseViewModelTest() {
    ...
    fun `CallToActionClick with all inputs valid should account created toast and hide dialog`() =
        runTest {
            ...
            verify(exactly = 1) {
                toastManager.show(messageId = R.string.account_created_success)
            }
        }
    ...
    fun `On init should show snackbar if from email is true`() = runTest {
        ...
        viewModel.eventFlow.test {
            assertEquals(
                CompleteRegistrationEvent.ShowSnackbar(R.string.email_verified.asText()),
                awaitItem(),
            )
        }
    }
    ...
    fun `CreateAccountClick with password below 12 chars should show password length dialog`() =
        runTest {
            ...
            val expectedState = DEFAULT_STATE.copy(
                ...
                dialog = CompleteRegistrationDialog.Error(
                    title = R.string.an_error_has_occurred.asText(),
                    message = R.plurals.master_password_length_val_message_x.asPluralsText(
                        quantity = 12,
                        args = arrayOf(12),
                    ),
                ),
