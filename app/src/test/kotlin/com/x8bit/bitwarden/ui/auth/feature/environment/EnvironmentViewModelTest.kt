package com.quantvault.app.ui.auth.feature.environment
...
import com.quantvault.app.data.platform.datasource.disk.model.MutualTlsKeyHost
import com.quantvault.app.data.platform.manager.CertificateManager
import com.quantvault.app.data.platform.manager.model.ImportPrivateKeyResult
import com.quantvault.app.data.platform.repository.util.FakeEnvironmentRepository
import com.quantvault.app.ui.platform.manager.keychain.model.PrivateKeyAliasSelectionResult
...
class EnvironmentViewModelTest : BaseViewModelTest() {
        ...
        runTest {
            ...
            verify(exactly = 1) {
                snackbarRelayManager.sendSnackbarData(
                    data = QuantVaultSnackbarData(message = R.string.environment_saved.asText()),
    ...
    fun `ImportKeyResultReceive should show snackbar with correct message on error`() = runTest {
        ...
        viewModel.eventFlow.test {
            ...
            assertEquals(
                EnvironmentEvent.ShowSnackbar(
                    R.string.unsupported_certificate_type.asText(),
                ),
                awaitItem(),
            )
            ...
            assertEquals(
                EnvironmentEvent.ShowSnackbar(
                    R.string.certificate_password_incorrect.asText(),
                ),
                awaitItem(),
            )
