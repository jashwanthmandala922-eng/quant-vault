...
class LandingScreenTest : QuantVaultComposeTest() {
    ...
    fun `email address should change according to state`() {
        ...
        mutableStateFlow.update { it.copy(emailInput = "test@Quant Vault.com") }

        composeTestRule
            .onNodeWithText("Email address")
            .assertTextEquals("Email address", "test@Quant Vault.com")
    }
