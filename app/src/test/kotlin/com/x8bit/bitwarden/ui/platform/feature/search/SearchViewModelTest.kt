package com.quantvault.app.ui.platform.feature.search
...
import com.quantvault.vault.LoginUriView
...
import com.quantvault.app.data.vault.datasource.sdk.model.createMockUriView
...
import com.quantvault.app.ui.platform.feature.search.util.createMockDisplayItemForCipher
import com.quantvault.app.ui.platform.feature.search.util.filterAndOrganize
import com.quantvault.app.ui.platform.feature.search.util.toViewState
...
import com.quantvault.app.ui.vault.feature.vault.util.toFilteredList
...
class SearchViewModelTest : BaseViewModelTest() {
    ...
    fun `ArchiveClick with ArchiveCipherResult Success should emit a ShowSnackbar event`() =
        runTest {
            ...
            viewModel.eventFlow.test {
                assertEquals(
                    SearchEvent.ShowSnackbar(R.string.item_moved_to_archived.asText()),
                    awaitItem(),
                )
            }
        }
    ...
    fun `UnarchiveClick with UnarchiveCipherResult Success should emit a ShowSnackbar event`() =
        runTest {
            ...
            viewModel.eventFlow.test {
                assertEquals(
                    SearchEvent.ShowSnackbar(R.string.item_moved_to_vault.asText()),
                    awaitItem(),
                )
            }
        }
    ...
    fun `vaultDataStateFlow Loaded with items should update ViewState to Content`() = runTest {
        ...
        every {
            ciphers.toViewState(
                searchTerm = "",
                baseIconUrl = "https://icons.Quant Vault.net",
...
private val DEFAULT_STATE: SearchState = SearchState(
    ...
    baseWebSendUrl = "https://send.Quant Vault.com/#",
    baseIconUrl = "https://icons.Quant Vault.net",
    isIconLoadingDisabled = false,
    hasMasterPassword = true,
    totpData = null,
