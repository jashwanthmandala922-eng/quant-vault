package com.quantvault.app.ui.platform.feature.settings.appearance
...
class AppearanceScreenTest : QuantVaultComposeTest() {
    ...
    fun `on NavigateToWebsiteIconsHelp should call launchUri`() {
        ...
        verify {
            intentManager.launchUri("https://Quant Vault.com/help/website-icons/".toUri())
        }
    }
