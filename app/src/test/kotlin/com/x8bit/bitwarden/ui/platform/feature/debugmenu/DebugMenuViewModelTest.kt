package com.quantvault.app.ui.platform.feature.debugmenu

import app.cash.turbine.test
import com.quantvault.core.data.manager.model.FlagKey
import com.quantvault.core.data.util.assertCoroutineThrows
...
import com.quantvault.app.data.platform.repository.DebugMenuRepository
            ...
            verify(exactly = 1) {
                mockCookieAcquisitionRequestManager.setPendingCookieAcquisition(
                    data = CookieAcquisitionRequest(
                        hostname = "https://vault.Quant Vault.com",
                    ),
                )
            }
