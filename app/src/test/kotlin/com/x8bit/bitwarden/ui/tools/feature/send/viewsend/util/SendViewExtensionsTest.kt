package com.quantvault.app.ui.tools.feature.send.viewsend.util
...
import com.quantvault.app.ui.tools.feature.send.viewsend.ViewSendState
...
class SendViewExtensionsTest {
    ...
    fun `toViewSendViewStateContent should create content with file data`() {
        ...
        val baseWebSendUrl = "https://send.Quant Vault.com/#"
