package com.quantvault.app.ui.platform.feature.settings.accountsecurity.loginapproval
...
class LoginApprovalViewModelTest : BaseViewModelTest() {
    ...
    fun `on ApproveRequestClick should approve auth request`() = runTest {
        ...
        verify {
            snackbarRelayManager.sendSnackbarData(
                data = QuantVaultSnackbarData(message = R.string.login_approved.asText()),
    ...
    fun `on DeclineRequestClick should deny auth request`() = runTest {
        ...
        verify {
            snackbarRelayManager.sendSnackbarData(
                data = QuantVaultSnackbarData(message = R.string.log_in_denied.asText()),
                relay = SnackbarRelay.LOGIN_APPROVAL,
            )
        }
        coVerify {
