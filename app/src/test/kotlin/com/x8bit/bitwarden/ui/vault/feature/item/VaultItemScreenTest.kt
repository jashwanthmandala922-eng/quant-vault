...
import com.quantvault.app.ui.vault.feature.attachments.preview.PreviewAttachmentRoute
...
@Suppress("LargeClass")
class VaultItemScreenTest : QuantVaultComposeTest() {
    ...
    fun `on ShowSnackbar should display snackbar content`() {
        ...
        mutableEventFlow.tryEmit(VaultItemEvent.ShowSnackbar(data = data))
        ...
        EMPTY_VIEW_STATES
            .forEach { typeState ->
                ...
                mutableStateFlow.update { currentState ->
                    updateCommonContent(currentState) {
                        copy(
                            lastUpdated = R.string.last_edited
...
private val DEFAULT_LOGIN: VaultItemState.ViewState.Content.ItemType.Login =
    VaultItemState.ViewState.Content.ItemType.Login(
        ...
        passwordRevisionDate = R.string.password_updated.asText("Apr 14, 1983 3:56 PM"),
        isPremiumUser = true,
        totpCodeItemData = TotpCodeItemData(
            periodSeconds = 30,
            timeLeftSeconds = 15,
