package com.quantvault.app.ui.vault.feature.itemlisting.util

import android.net.Uri
import androidx.core.os.bundleOf
import androidx.credentials.provider.ProviderCreateCredentialRequest
import com.quantvault.core.data.util.toFormattedDateTimeStyle
...
import com.quantvault.app.data.platform.util.subtitle
...
import com.quantvault.app.ui.vault.feature.itemlisting.VaultItemListingState
...
class VaultItemListingDataExtensionsTest {
    ...
    fun `toViewState should transform an empty list of CipherViews into a NoItems ViewState with the appropriate data`() {
        ...
        assertEquals(
            VaultItemListingState.ViewState.NoItems(
                header = R.string.no_archives_title.asText(),
                message = R.string.no_archives_message.asText(),
                vectorRes = R.drawable.ill_open_source,
                shouldShowAddButton = false,
                buttonText = R.string.new_item.asText(),
            ),
            vaultData.toViewState(
        ...
        assertEquals(
            VaultItemListingState.ViewState.NoItems(
                ...
                shouldShowAddButton = false,
                buttonText = R.string.new_item.asText(),
                vectorRes = R.drawable.ill_folder_question,
            ),
            vaultData.toViewState(
                itemListingType = VaultItemListingState.ItemListingType.Vault.Trash,
                vaultFilterType = VaultFilterType.AllVaults,
