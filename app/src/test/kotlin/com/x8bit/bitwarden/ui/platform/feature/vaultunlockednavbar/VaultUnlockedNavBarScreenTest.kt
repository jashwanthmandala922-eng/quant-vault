package com.quantvault.app.ui.platform.feature.vaultunlockednavbar
...
import com.quantvault.app.ui.platform.feature.settings.SettingsGraphRoute
import com.quantvault.app.ui.tools.feature.generator.GeneratorGraphRoute
import com.quantvault.app.ui.tools.feature.send.SendGraphRoute
import com.quantvault.app.ui.vault.feature.vault.VaultGraphRoute
...
class VaultUnlockedNavBarScreenTest : QuantVaultComposeTest() {
    ...
    fun `NavigateToVaultScreen should navigate to VaultScreen`() {
        mutableEventFlow.tryEmit(
            VaultUnlockedNavBarEvent.NavigateToVaultScreen(labelRes = R.string.my_vault),
        )
