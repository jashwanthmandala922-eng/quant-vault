package com.quantvault.app.ui.platform.feature.cookieacquisition
...
import com.quantvault.app.data.platform.manager.network.NetworkCookieManager
                ...
                assertEquals(
                    CookieAcquisitionEvent.LaunchBrowser(
                        ...
                        authTabData = AuthTabData.CustomScheme(
                            callbackUrl = "quantvault://sso-cookie-vendor",
                        ),
                    ),
                    awaitItem(),
                )
                ...
                assertEquals(
                    DEFAULT_STATE.copy(
                        dialogState = CookieAcquisitionDialogState.Error(
                            title = R.string.an_error_has_occurred
                                .asText(),
    ...
    fun `initial state should use environment URL when no saved state`() {
        ...
        assertEquals(
            CookieAcquisitionState(
                environmentUrl = "https://vault.Quant Vault.com",
                hostname = DEFAULT_HOSTNAME,
                dialogState = null,
            ),
...
private val DEFAULT_STATE = CookieAcquisitionState(
    environmentUrl = "https://vault.Quant Vault.us",
    hostname = DEFAULT_HOSTNAME,
    dialogState = null,
)
