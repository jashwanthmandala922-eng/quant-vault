package com.quantvault.app.ui.vault.feature.movetoorganization
...
import com.quantvault.app.ui.vault.feature.movetoorganization.util.createMockOrganizationList
...
class VaultMoveToOrganizationViewModelTest : BaseViewModelTest() {
    ...
    fun `MoveClick with onlyShowCollections true should invoke updateCipherCollections`() =
        runTest {
            ...
            verify {
                snackbarRelayManager.sendSnackbarData(
                    data = QuantVaultSnackbarData(message = R.string.item_updated.asText()),
                    relay = SnackbarRelay.CIPHER_MOVED_TO_ORGANIZATION,
                )
            }
            coVerify {
