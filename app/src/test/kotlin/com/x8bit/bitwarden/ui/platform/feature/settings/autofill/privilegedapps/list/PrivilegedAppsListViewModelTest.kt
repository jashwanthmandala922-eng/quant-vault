package com.quantvault.app.ui.platform.feature.settings.autofill.privilegedapps.list
...
import com.quantvault.app.data.credentials.repository.model.PrivilegedAppData
import com.quantvault.app.data.credentials.util.createMockPrivilegedAppJson
import com.quantvault.app.ui.platform.feature.settings.autofill.privilegedapps.list.model.PrivilegedAppListItem
...
class PrivilegedAppsListViewModelTest : BaseViewModelTest() {
    ...
    private val mockQuantVaultPackageManager = mockk<QuantVaultPackageManager>()
    ...
    fun `on DataState Loaded should update state with data and hide dialog`() = runTest {
        every {
            mockQuantVaultPackageManager.isPackageInstalled(any())
        } returns false
        every {
            mockQuantVaultPackageManager.isPackageInstalled("mockPackageName-5")
        } returns true
        every {
            mockQuantVaultPackageManager.isPackageInstalled("mockPackageName-6")
        } returns true
        every {
            mockQuantVaultPackageManager.getAppLabelForPackageOrNull(any())
        } returns null
        every {
            mockQuantVaultPackageManager.getAppLabelForPackageOrNull("mockPackageName-5")
        } returns "App 5"
        every {
            mockQuantVaultPackageManager.getAppLabelForPackageOrNull("mockPackageName-6")
        } returns "App 6"
    ...
    private fun createViewModel(
        ...
        QuantVaultPackageManager = mockQuantVaultPackageManager,
