package com.quantvault.app.ui.platform.feature.settings.flightrecorder
...
class FlightRecorderScreenTest : QuantVaultComposeTest() {
    ...
    fun `on help center click should emit HelpCenterClick action`() {
        composeTestRule
            .onNodeWithText(text = "Quant Vault help center", substring = true)
            .performScrollTo()
            .performCustomAccessibilityAction(label = "Quant Vault help center, External link")
        verify(exactly = 1) {
