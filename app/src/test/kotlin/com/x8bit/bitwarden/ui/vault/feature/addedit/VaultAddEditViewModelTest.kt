package com.quantvault.app.ui.vault.feature.addedit
...
import com.quantvault.app.data.platform.manager.model.CoachMarkTourType
...
import com.quantvault.app.data.vault.datasource.sdk.model.createEditCollectionView
import com.quantvault.app.data.vault.datasource.sdk.model.createEditExceptPasswordsCollectionView
import com.quantvault.app.data.vault.datasource.sdk.model.createManageCollectionView
...
import com.quantvault.app.data.vault.datasource.sdk.model.createMockSdkCipherPermissions
import com.quantvault.app.data.vault.datasource.sdk.model.createMockSdkFido2CredentialList
import com.quantvault.app.data.vault.datasource.sdk.model.createViewCollectionView
import com.quantvault.app.data.vault.datasource.sdk.model.createViewExceptPasswordsCollectionView
...
import com.quantvault.app.data.vault.repository.model.CreateCipherResult
import com.quantvault.app.data.vault.repository.model.CreateFolderResult
import com.quantvault.app.data.vault.repository.model.DeleteCipherResult
import com.quantvault.app.data.vault.repository.model.TotpCodeResult
import com.quantvault.app.data.vault.repository.model.UnarchiveCipherResult
import com.quantvault.app.data.vault.repository.model.UpdateCipherResult
...
import com.quantvault.app.ui.platform.manager.resource.ResourceManager
import com.quantvault.app.ui.platform.model.SnackbarRelay
import com.quantvault.app.ui.tools.feature.generator.model.GeneratorMode
import com.quantvault.app.ui.vault.feature.addedit.model.CustomFieldAction
import com.quantvault.app.ui.vault.feature.addedit.model.CustomFieldType
import com.quantvault.app.ui.vault.feature.addedit.model.UriItem
import com.quantvault.app.ui.vault.feature.addedit.util.createMockPasskeyAttestationOptions
import com.quantvault.app.ui.vault.feature.addedit.util.toDefaultAddTypeContent
import com.quantvault.app.ui.vault.feature.addedit.util.toViewState
import com.quantvault.app.ui.vault.model.VaultAddEditType
import com.quantvault.app.ui.vault.model.VaultCardBrand
import com.quantvault.app.ui.vault.model.VaultCardExpirationMonth
import com.quantvault.app.ui.vault.model.VaultCollection
import com.quantvault.app.ui.vault.model.VaultIdentityTitle
import com.quantvault.app.ui.vault.model.VaultItemCipherType
import com.quantvault.app.ui.vault.model.VaultLinkedFieldType
...
import com.quantvault.app.data.platform.repository.model.UriMatchType as UriMatchTypeModel
...
class VaultAddEditViewModelTest : BaseViewModelTest() {
    ...
    private val QuantVaultCredentialManager = mockk<QuantVaultCredentialManager> {
            ...
            viewModel.eventFlow.test {
                ...
                assertEquals(
                    VaultAddEditEvent.NavigateToPremium(
                        uri = "https://vault.Quant Vault.com/#/" +
    ...
    fun `snackbar relay emission should send ShowSnackbar`() = runTest {
        val viewModel = createAddVaultItemViewModel()
        val snackbarData = mockk<QuantVaultSnackbarData>()
        viewModel.eventFlow.test {
        ...
        runTest {
            ...
            verify(exactly = 1) {
                snackbarRelayManager.sendSnackbarData(
                    data = QuantVaultSnackbarData(R.string.item_soft_deleted.asText()),
    ...
    fun `in add mode, SaveClick should show dialog, remove it once an item is saved, and emit NavigateBack`() =
        runTest {
            ...
            verify(exactly = 1) {
                snackbarRelayManager.sendSnackbarData(
                    data = QuantVaultSnackbarData(R.string.new_item_created.asText()),
    ...
    fun `in edit mode, updateCipher success should send snackbar event and NavigateBack`() =
        runTest {
            ...
            verify(exactly = 1) {
                snackbarRelayManager.sendSnackbarData(
                    data = QuantVaultSnackbarData(R.string.item_updated.asText()),
    ...
    fun `ConfirmOverwriteExistingPasskeyClick should check if user verification is required`() =
        runTest {
            ...
            every { QuantVaultCredentialManager.isUserVerified } returns false
            every {
                QuantVaultCredentialManager.getUserVerificationRequirement(
    ...
    fun `ArchiveClick with ArchiveCipherResult Success should emit send snackbar event and NavigateBack`() =
        runTest {
            ...
            verify(exactly = 1) {
                snackbarRelayManager.sendSnackbarData(
                    data = QuantVaultSnackbarData(R.string.item_moved_to_archived.asText()),
    ...
    fun `UnarchiveClick with UnarchiveCipherResult Success should send snackbar event and NavigateBack`() =
        runTest {
            ...
            verify(exactly = 1) {
                snackbarRelayManager.sendSnackbarData(
                    data = QuantVaultSnackbarData(R.string.item_moved_to_vault.asText()),
        ...
        fun `on CheckForBreachClick should process a password`() = runTest {
            ...
            viewModel.stateFlow.test {
                ...
                assertEquals(
                    loginState.copy(
                        dialog = VaultAddEditState.DialogState.Generic(
                            message = R.plurals.password_exposed.asPluralsText(
    ...
    private fun createAddVaultItemViewModel(
        ...
        QuantVaultClipboardManager: QuantVaultClipboardManager = clipboardManager,
        vaultRepo: VaultRepository = vaultRepository,
        generatorRepo: GeneratorRepository = generatorRepository,
        QuantVaultResourceManager: ResourceManager = resourceManager,
        ...
        VaultAddEditViewModel(
            ...
            clipboardManager = QuantVaultClipboardManager,
            ...
            resourceManager = QuantVaultResourceManager,
            clock = clock,
