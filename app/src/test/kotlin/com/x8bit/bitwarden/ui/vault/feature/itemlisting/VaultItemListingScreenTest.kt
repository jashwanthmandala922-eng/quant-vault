...
import com.quantvault.app.ui.tools.feature.send.viewsend.ViewSendRoute
import com.quantvault.app.ui.vault.components.model.CreateVaultItemType
import com.quantvault.app.ui.vault.feature.addedit.VaultAddEditArgs
import com.quantvault.app.ui.vault.feature.item.VaultItemArgs
...
@Suppress("LargeClass")
class VaultItemListingScreenTest : QuantVaultComposeTest() {
    ...
    fun `on ShowSnackbar event should display the snackbar`() {
        val message = "message"
        val data = QuantVaultSnackbarData(message = message.asText())
    ...
    fun `cipher decryption error dialog should be shown or hidden according to the state`() {
        ...
        val errorMessage =
            "Quant Vault could not decrypt this vault item. Copy and share this error report with customer success to avoid additional data loss."
        composeTestRule.assertNoDialogExists()
        composeTestRule
