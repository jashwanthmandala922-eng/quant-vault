...
import com.quantvault.app.ui.platform.manager.permissions.FakePermissionManager
...
@Suppress("LargeClass")
class VaultAddEditScreenTest : QuantVaultComposeTest() {
    ...
    fun `InitialAutofillPrompt is shown according to state`() {
        ...
        composeTestRule
            .onAllNodesWithText("Quant Vault Autofill Service")
            .filterToOne(hasAnyAncestor(isDialog()))
            .assertIsDisplayed()
    ...
    fun `on NavigateToLearnMore should call launchUri`() {
        ...
        verify(exactly = 1) {
            intentManager.launchUri(uri = "https://Quant Vault.com/help/uri-match-detection/".toUri())
        }
    }
