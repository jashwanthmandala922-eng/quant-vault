...
class CookieAcquisitionRequestManagerTest {
    ...
    fun `setPendingCookieAcquisition emits new value to flow`() = runTest {
        val pending = CookieAcquisitionRequest(hostname = "vault.Quant Vault.com")
    ...
    fun `setPendingCookieAcquisition replaces existing value`() = runTest {
        val pending1 = CookieAcquisitionRequest(hostname = "vault1.Quant Vault.com")
        val pending2 = CookieAcquisitionRequest(hostname = "vault2.Quant Vault.com")
