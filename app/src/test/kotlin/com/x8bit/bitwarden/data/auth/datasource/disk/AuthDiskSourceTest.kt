package com.quantvault.app.data.auth.datasource.disk
...
import com.quantvault.app.data.platform.datasource.disk.legacy.LegacySecureStorageMigrator
...
class AuthDiskSourceTest {
    ...
    fun `rememberedOrgIdentifier should pull from and update SharedPreferences`() {
        ...
        authDiskSource.rememberedOrgIdentifier = "Quant Vault"
        assertEquals(
            "Quant Vault",
