package com.quantvault.app.data.credentials.manager
...
import com.quantvault.app.data.credentials.builder.CredentialEntryBuilder
import com.quantvault.app.data.credentials.model.Fido2AttestationResponse
import com.quantvault.app.data.credentials.model.Fido2CredentialAssertionResult
import com.quantvault.app.data.credentials.model.Fido2PublicKeyCredential
...
import com.quantvault.app.data.credentials.model.PasskeyAttestationOptions
import com.quantvault.app.data.credentials.model.UserVerificationRequirement
import com.quantvault.app.data.credentials.sanitizer.PasskeyAttestationOptionsSanitizer
import com.quantvault.app.data.platform.manager.ciphermatching.CipherMatchingManager
import com.quantvault.app.data.platform.util.getAppSigningSignatureFingerprint
...
import com.quantvault.app.data.vault.datasource.sdk.model.createMockFido2CredentialAutofillView
import com.quantvault.app.data.vault.datasource.sdk.model.createMockLoginListView
import com.quantvault.app.data.vault.datasource.sdk.model.createMockPublicKeyAssertionResponse
import com.quantvault.app.data.vault.datasource.sdk.model.createMockPublicKeyAttestationResponse
import com.quantvault.app.data.vault.datasource.sdk.util.toAndroidFido2PublicKeyCredential
import com.quantvault.app.data.vault.repository.VaultRepository
import com.quantvault.app.ui.vault.feature.addedit.util.createMockPasskeyAssertionOptions
...
@Suppress("LargeClass")
class quantvaultCredentialManagerTest {

    private lateinit var QuantVaultCredentialManager: QuantVaultCredentialManager
    ...
    val mockCallingAppInfo = mockk<CallingAppInfo> {
        ...
        every { packageName } returns "com.quantvault.app"
    ...
    fun setUp() {
        ...
        QuantVaultCredentialManager = QuantVaultCredentialManagerImpl(
    ...
    fun `getPasskeyAttestationOptionsOrNull should return passkey options when deserialized`() =
        runTest {
            assertEquals(
                ...
                QuantVaultCredentialManager.getPasskeyAttestationOptionsOrNull(
    ...
    fun `getPasskeyAttestationOptionsOrNull should return null when decoding fails`() {
        ...
        assertNull(QuantVaultCredentialManager.getPasskeyAttestationOptionsOrNull(requestJson = ""))
    }
    ...
    fun `registerFido2Credential should return Error when getAppSigningSignatureFingerprint is null`() =
        runTest {
            ...
            val result = QuantVaultCredentialManager.registerFido2Credential(
                userId = "mockUserId",
                createPublicKeyCredentialRequest = mockCreatePublicKeyCredentialRequest,
                selectedCipherView = createMockCipherView(number = 1),
                callingAppInfo = mockCallingAppInfo,
    ...
    fun `hasAuthenticationAttemptsRemaining returns true when authenticationAttempts is less than 5`() {
        assertTrue(QuantVaultCredentialManager.hasAuthenticationAttemptsRemaining())
    }

    @Suppress("MaxLineLength")
    @Test
    fun `hasAuthenticationAttemptsRemaining returns false when authenticationAttempts is greater than 5`() {
        QuantVaultCredentialManager.authenticationAttempts = 6
        assertFalse(QuantVaultCredentialManager.hasAuthenticationAttemptsRemaining())
    }
    ...
    fun `authenticateFido2Credential should return Error when origin is null`() = runTest {
        ...
        val result = QuantVaultCredentialManager.authenticateFido2Credential(
            userId = "activeUserId",
            request = mockGetPublicKeyCredentialOption,
            selectedCipherView = mockSelectedCipher,
            callingAppInfo = mockCallingAppInfo,
    ...
    fun `authenticateFidoCredential should convert SDK response to AndroidFido2PublicKeyCredential, deserialize the response to JSON, and return Success with response JSON`() =
        runTest {
            ...
            val authResult = QuantVaultCredentialManager.authenticateFido2Credential(
                userId = "activeUserId",
                request = mockGetPublicKeyCredentialOption,
                selectedCipherView = createMockCipherView(number = 1),
                callingAppInfo = mockCallingAppInfo,
    ...
    fun `getCredentialEntries with public key credential options should return empty list when no ciphers have FIDO 2 credentials`() =
        runTest {
            ...
            val result = QuantVaultCredentialManager.getCredentialEntries(mockGetCredentialsRequest)
    ...
    fun `getCredentialEntries with public key credential options should return Failure when relyingPartyId is null`() =
        runTest {
            ...
            val result = QuantVaultCredentialManager.getCredentialEntries(
    ...
    fun `getCredentialEntries with public key credential options should return error when FIDO 2 relyingPartyId is null`() =
        runTest {
            ...
            val result = QuantVaultCredentialManager
    ...
    fun `getCredentialEntries should build password credential entries`() =
        runTest {
            ...
            QuantVaultCredentialManager.getCredentialEntries(mockGetCredentialsRequest)
...
private const val DEFAULT_PACKAGE_NAME = "com.quantvault.app"
...
private const val DEFAULT_HOST = "Quant Vault.com"
...
private val DEFAULT_WEB_ORIGIN = Origin.Web("https://Quant Vault.com")
private const val DEFAULT_FIDO2_AUTH_REQUEST_JSON = """
{
  "allowCredentials": [],
  "challenge": "mockChallenge",
  "rpId": "Quant Vault.com",
