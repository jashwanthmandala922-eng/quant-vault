...
import com.quantvault.network.model.createMockCipherMiniResponseJson
...
import com.quantvault.app.data.platform.manager.model.NetworkSignalStrength
...
import com.quantvault.app.data.vault.manager.model.VaultMigrationData
import com.quantvault.app.data.vault.repository.VaultRepository
import com.quantvault.app.data.vault.repository.model.MigratePersonalVaultResult
...
class VaultMigrationManagerTest {
    ...
    private val ciphersService: com.quantvault.network.service.CiphersService =
        mockk(relaxed = true)
                ...
                data = createVaultData(
                    ...
                    collectionViewList = listOf(
                        createMockCollectionView(
                            number = 1,
                            type = com.quantvault.collections.CollectionType.DEFAULT_USER_COLLECTION,
                        ),
                    ),
                ),
            )
