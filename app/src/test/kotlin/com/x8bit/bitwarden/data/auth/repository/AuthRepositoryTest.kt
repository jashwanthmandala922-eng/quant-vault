...
import com.quantvault.core.data.repository.error.MissingPropertyException
...
import com.quantvault.network.model.PasswordHintResponseJson
...
import com.quantvault.network.model.TrustedDeviceUserDecryptionOptionsJson
import com.quantvault.network.model.TwoFactorAuthMethod
import com.quantvault.network.model.TwoFactorDataModel
import com.quantvault.network.model.UserDecryptionOptionsJson
import com.quantvault.network.model.VerificationCodeResponseJson
...
import com.quantvault.network.model.createMockAccountKeysJsonWithNullFields
import com.quantvault.network.model.createMockOrganizationNetwork
...
import com.quantvault.app.data.auth.datasource.disk.model.AccountJson
import com.quantvault.app.data.auth.datasource.disk.model.AccountTokensJson
import com.quantvault.app.data.auth.datasource.disk.model.ForcePasswordResetReason
import com.quantvault.app.data.auth.datasource.disk.model.OnboardingStatus
import com.quantvault.app.data.auth.datasource.disk.model.PendingAuthRequestJson
import com.quantvault.app.data.auth.datasource.disk.model.UserStateJson
import com.quantvault.app.data.auth.datasource.disk.util.FakeAuthDiskSource
import com.quantvault.app.data.auth.datasource.sdk.AuthSdkSource
import com.quantvault.app.data.auth.datasource.sdk.model.PasswordStrength.LEVEL_0
import com.quantvault.app.data.auth.datasource.sdk.model.PasswordStrength.LEVEL_1
import com.quantvault.app.data.auth.datasource.sdk.model.PasswordStrength.LEVEL_2
import com.quantvault.app.data.auth.datasource.sdk.model.PasswordStrength.LEVEL_3
import com.quantvault.app.data.auth.datasource.sdk.model.PasswordStrength.LEVEL_4
import com.quantvault.app.data.auth.datasource.sdk.util.toKdfRequestModel
import com.quantvault.app.data.auth.manager.AuthRequestManager
import com.quantvault.app.data.auth.manager.KdfManager
import com.quantvault.app.data.auth.manager.KeyConnectorManager
import com.quantvault.app.data.auth.manager.TrustedDeviceManager
import com.quantvault.app.data.auth.manager.UserLogoutManager
import com.quantvault.app.data.auth.manager.UserStateManager
import com.quantvault.app.data.auth.manager.model.AuthRequest
...
import com.quantvault.app.data.auth.repository.model.BreachCountResult
import com.quantvault.app.data.auth.repository.model.DeleteAccountResult
import com.quantvault.app.data.auth.repository.model.EmailTokenResult
import com.quantvault.app.data.auth.repository.model.KnownDeviceResult
import com.quantvault.app.data.auth.repository.model.LeaveOrganizationResult
...
import com.quantvault.app.data.auth.repository.model.NewSsoUserResult
import com.quantvault.app.data.auth.repository.model.Organization
import com.quantvault.app.data.auth.repository.model.PasswordHintResult
import com.quantvault.app.data.auth.repository.model.PasswordStrengthResult
import com.quantvault.app.data.auth.repository.model.PrevalidateSsoResult
import com.quantvault.app.data.auth.repository.model.RegisterResult
import com.quantvault.app.data.auth.repository.model.RemovePasswordResult
import com.quantvault.app.data.auth.repository.model.RequestOtpResult
import com.quantvault.app.data.auth.repository.model.ResendEmailResult
import com.quantvault.app.data.auth.repository.model.ResetPasswordResult
import com.quantvault.app.data.auth.repository.model.SendVerificationEmailResult
import com.quantvault.app.data.auth.repository.model.SetPasswordResult
import com.quantvault.app.data.auth.repository.model.SwitchAccountResult
import com.quantvault.app.data.auth.repository.model.UpdateKdfMinimumsResult
...
import com.quantvault.app.data.auth.repository.model.VerifyOtpResult
import com.quantvault.app.data.auth.repository.model.createMockOrganization
import com.quantvault.app.data.auth.repository.util.CookieCallbackResult
import com.quantvault.app.data.auth.repository.util.DuoCallbackTokenResult
import com.quantvault.app.data.auth.repository.util.SsoCallbackResult
import com.quantvault.app.data.auth.repository.util.WebAuthResult
import com.quantvault.app.data.auth.repository.util.accountKeysJson
import com.quantvault.app.data.auth.repository.util.toRemovedPasswordUserStateJson
import com.quantvault.app.data.auth.repository.util.toSdkParams
import com.quantvault.app.data.auth.repository.util.toUserState
import com.quantvault.app.data.auth.util.YubiKeyResult
import com.quantvault.app.data.auth.util.toSdkParams
import com.quantvault.app.data.platform.datasource.disk.util.FakeSettingsDiskSource
...
import com.quantvault.app.data.platform.manager.LogsManager
import com.quantvault.app.data.platform.manager.PolicyManager
import com.quantvault.app.data.platform.manager.PushManager
import com.quantvault.app.data.platform.manager.model.NotificationLogoutData
...
import com.quantvault.app.data.vault.repository.model.VaultUnlockData
import com.quantvault.app.data.vault.repository.model.VaultUnlockResult
import com.quantvault.app.data.vault.repository.util.createWrappedAccountCryptographicState
...
class AuthRepositoryTest {
    ...
    fun `rememberedOrgIdentifier should pull from and update AuthDiskSource`() {
        ...
        // Updating the repository updates AuthDiskSource
        repository.rememberedOrgIdentifier = "Quant Vault"
        assertEquals("Quant Vault", fakeAuthDiskSource.rememberedOrgIdentifier)
    ...
    @Suppress("MaxLineLength")
    @Test
    fun `login get token fails should return Error with no message when server is an official Quant Vault server`() =
        runTest {
            val error = RuntimeException()
            coEvery {
                identityService.preLogin(email = EMAIL)
    ...
    @Suppress("MaxLineLength")
    @Test
    fun `login get token fails should return UnofficialServerError when server is an unofficial Quant Vault server`() =
        runTest {
    ...
    fun `resetPassword Success should return Success`() = runTest {
        ...
        verify(exactly = 1) {
            toastManager.show(messageId = R.string.updated_master_password)
    ...
    companion object {
        ...
        private const val DEEPLINK_SCHEME = "Quant Vault"
        private const val UNIQUE_APP_ID = "testUniqueAppId"
        private const val NAME = "Example Name"
        private const val EMAIL = "test@Quant Vault.com"
        private const val EMAIL_2 = "test2@Quant Vault.com"
        ...
        private const val SSO_REDIRECT_URI = "quantvault://sso-test"
