package com.quantvault.app.data.autofill.accessibility.util

import android.view.accessibility.AccessibilityNodeInfo
import com.quantvault.app.data.autofill.accessibility.model.AccessOptions
import com.quantvault.app.data.autofill.accessibility.model.KnownUsernameField
...
class AccessibilityNodeInfoExtensionsTest {
    ...
    fun `isSystemPackage when packageName is populated with non system UI package should return false`() {
        val accessibilityNodeInfo = mockk<AccessibilityNodeInfo> {
            every { packageName } returns "com.quantvault.app.beta"
        }
    ...
    @Suppress("MaxLineLength")
    @Test
    fun `shouldSkipPackage when packageName is prefixed with Quant Vault package should return true`() {
        val accessibilityNodeInfo = mockk<AccessibilityNodeInfo> {
            every { packageName } returns "com.quantvault.app.beta"
        }
