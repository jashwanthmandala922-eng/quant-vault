...
import com.quantvault.app.data.platform.repository.util.sanitizeTotpUri
import com.quantvault.app.data.vault.datasource.disk.VaultDiskSource
import com.quantvault.app.data.vault.datasource.sdk.ScopedVaultSdkSource
...
private val ACCOUNT_JSON_1 = AccountJson(
    ...
    settings = AccountJson.Settings(
        environmentUrlData = EnvironmentUrlDataJson(
            base = "https://vault.Quant Vault.com",
        ),
    ),
)
