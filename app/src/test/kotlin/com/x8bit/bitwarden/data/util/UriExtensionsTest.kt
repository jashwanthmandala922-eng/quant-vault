...
import com.quantvault.app.data.platform.manager.model.DomainName
import com.quantvault.app.data.platform.util.addSchemeToUriIfNecessary
import com.quantvault.app.data.platform.util.parseDomainNameOrNull
...
class UriExtensionsTest {
    ...
    fun `addSchemeToUriIfNecessary should not add https when custom scheme is already present`() {
        val uriWithCustomScheme = URI("quantvault://example.com")
        assertEquals(
            URI("quantvault://example.com"),
