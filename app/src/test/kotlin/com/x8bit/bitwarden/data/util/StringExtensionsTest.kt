package com.quantvault.app.data.util

import com.quantvault.app.data.platform.manager.ResourceCacheManager
import com.quantvault.app.data.platform.util.findLastSubstringIndicesOrNull
...
import com.quantvault.app.data.platform.util.hasHttpProtocol
import com.quantvault.app.data.platform.util.hasPort
import com.quantvault.app.data.platform.util.isAndroidApp
import com.quantvault.app.data.platform.util.isIpAddress
import com.quantvault.app.data.platform.util.parseDomainOrNull
import com.quantvault.app.data.platform.util.toUriOrNull
...
class StringExtensionsTest {
    ...
    fun `getWebHostFromAndroidUriOrNull should return null when not android app`() {
        assertNull("com.quantvault.app".getWebHostFromAndroidUriOrNull())
    }

    @Test
    fun `getWebHostFromAndroidUriOrNull should return null when no dot`() {
        assertNull("androidapp://comx8bitQuant Vault".getWebHostFromAndroidUriOrNull())
    }
    ...
    fun `getWebHostFromAndroidUriOrNull should return web host when has dot`() {
        ...
        // Test
        val actual = "androidapp://com.quantvault.app".getWebHostFromAndroidUriOrNull()
