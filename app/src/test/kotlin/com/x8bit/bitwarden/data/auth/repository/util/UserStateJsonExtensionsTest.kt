...
import com.quantvault.network.model.UserDecryptionJson
...
import com.quantvault.app.data.auth.repository.model.UserAccountTokens
import com.quantvault.app.data.auth.repository.model.UserKeyConnectorState
import com.quantvault.app.data.auth.repository.model.UserOrganizations
...
import com.quantvault.app.data.auth.util.KdfParamsConstants.DEFAULT_PBKDF2_ITERATIONS
...
class UserStateJsonExtensionsTest {
    ...
    fun `toUserStateJsonKdfUpdatedMinimums should preserve other profile data while updating KDF`() {
        ...
        val originalAccount = AccountJson(
            ...
            tokens = null,
            settings = AccountJson.Settings(
                environmentUrlData = EnvironmentUrlDataJson(base = "https://vault.Quant Vault.com"),
            ),
        )
        val originalUserState = UserStateJson(
            activeUserId = "activeUserId",
