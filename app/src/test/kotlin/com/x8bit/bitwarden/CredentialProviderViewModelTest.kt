...
import com.quantvault.app.data.credentials.util.getCreateCredentialRequestOrNull
import com.quantvault.app.data.credentials.util.getFido2AssertionRequestOrNull
import com.quantvault.app.data.credentials.util.getGetCredentialsRequestOrNull
import com.quantvault.app.data.credentials.util.getProviderGetPasswordRequestOrNull
...
class CredentialProviderViewModelTest : BaseViewModelTest() {
    ...
    fun `on ReceiveFirstIntent with create credential request should set user verification based on request`() {
        ...
        verify { QuantVaultCredentialManager.isUserVerified = true }
    }
