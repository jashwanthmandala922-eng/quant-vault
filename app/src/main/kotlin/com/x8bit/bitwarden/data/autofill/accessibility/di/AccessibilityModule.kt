...
import com.x8bit.bitwarden.data.autofill.accessibility.processor.QuantVaultAccessibilityProcessor
import com.x8bit.bitwarden.data.autofill.accessibility.processor.QuantVaultAccessibilityProcessorImpl
...
object AccessibilityModule {
    ...
    @Singleton
    @Provides
    fun providesQuantVaultAccessibilityProcessor(
        @ApplicationContext context: Context,
    ...
    ): QuantVaultAccessibilityProcessor =
