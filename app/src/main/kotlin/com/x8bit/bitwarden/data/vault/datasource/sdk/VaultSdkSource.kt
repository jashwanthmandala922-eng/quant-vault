...
import com.quantvault.sdk.Collection
import com.quantvault.sdk.CollectionId
import com.quantvault.sdk.CollectionView
import com.quantvault.crypto.EnrollPinResponse
import com.quantvault.crypto.InitOrgCryptoRequest
import com.quantvault.auth.InitUserCryptoMethod
import com.quantvault.crypto.InitUserCryptoRequest
import com.quantvault.auth.UpdateKdfResponse
import com.quantvault.crypto.UpdatePasswordResponse
...
import com.quantvault.sdk.Fido2CredentialAutofillView
import com.quantvault.sdk.PublicKeyCredentialAuthenticatorAssertionResponse
import com.quantvault.sdk.PublicKeyCredentialAuthenticatorAttestationResponse
...
import com.quantvault.sdk.AttachmentEncryptResult
...
import com.quantvault.sdk.PasswordHistoryView
import com.quantvault.sdk.TotpResponse
...
/**
 * Source of vault information and functionality from the Quant Vault SDK.
 */
...
interface VaultSdkSource {
     ...
     * [userId] for the Quant Vault SDK with a given [InitUserCryptoRequest].
     */
     ...
     * the user with the given [userId] for the Quant Vault SDK with a given [InitOrgCryptoRequest].
     *
     * This should only be called after a successful call to [initializeCrypto] for the associated
     * user.
     */
