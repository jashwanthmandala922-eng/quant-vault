...
import com.quantvault.sdk.CollectionType
...
import com.quantvault.network.model.CollectionTypeJson
import com.quantvault.network.model.SyncResponseJson

/**
 * Converts a [SyncResponseJson.Collection] object to a corresponding Quant Vault SDK [Collection]
 * object.
 */
 ...
 * Quant Vault SDK [Collection] objects.
 */
 ...
 * Quant Vault SDK [CollectionTypeJson] object.
 */
