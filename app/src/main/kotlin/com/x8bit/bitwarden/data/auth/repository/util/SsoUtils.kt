...
private val QUANT_VAULT_HOSTS: List<String> = listOf("quantvault.com", "quantvault.eu", "quantvault.pw")
private const val APP_LINK_SCHEME: String = "https"
private const val DEEPLINK_SCHEME: String = "quantvault"
...
fun Intent.getSsoCallbackResult(): SsoCallbackResult? {
    ...
    return when (localData.scheme) {
        ...
        APP_LINK_SCHEME -> {
            if (localData.host in QUANT_VAULT_HOSTS && localData.path == "/$CALLBACK") {
                localData.getSsoCallbackResult()
            } else {
                null
            }
