...
import com.x8bit.bitwarden.data.platform.manager.model.QuantVaultNotification
...
/**
 * The amount of time to delay before updating the push token against Quant Vault server.
 */
...
class PushManagerImpl @Inject constructor(
    ...
    override fun onMessageReceived(data: Map<String, String>) {
        ...
        val notification = QuantVaultNotification(
    ...
    private fun onMessageReceived(notification: QuantVaultNotification) {
