...
private const val PACKAGE_NAME_Quant Vault_PREFIX: String = "com.quantvault.app"
...
val AccessibilityNodeInfo.shouldSkipPackage: Boolean
    get() {
        ...
        if (packageName.startsWith(prefix = PACKAGE_NAME_Quant Vault_PREFIX)) return true
