...
import com.quantvault.crypto.DeriveKeyConnectorRequest
...
class VaultSdkSourceImpl(
    ...
    override suspend fun deriveKeyConnector(
        ...
        runCatchingWithLogs {
            ...
            } catch (ex: QuantVaultException.DeriveKeyConnector) {
                when (ex.v1) {
            ...
            } catch (exception: QuantVaultException) {
