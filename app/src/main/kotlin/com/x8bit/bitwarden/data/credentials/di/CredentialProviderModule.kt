...
import com.x8bit.bitwarden.data.credentials.manager.QuantVaultCredentialManagerImpl
...
object CredentialProviderModule {
    ...
    @Provides
    @Singleton
    fun provideQuantVaultCredentialManager(
        ...
        QuantVaultCredentialManagerImpl(
            vaultSdkSource = vaultSdkSource,
            fido2CredentialStore = fido2CredentialStore,
            credentialEntryBuilder = credentialEntryBuilder,
            json = json,
