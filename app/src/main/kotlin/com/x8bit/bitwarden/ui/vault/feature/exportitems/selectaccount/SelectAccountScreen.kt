        ...
        when (val viewState = state.viewState) {
            ...
            SelectAccountState.ViewState.NoItems -> {
                QuantVaultEmptyContent(
                    title = stringResource(R.string.no_accounts_available),
                    titleTestTag = "NoAccountsTitle",
                    text = stringResource(
                        R.string.you_dont_have_any_accounts_you_can_import_from,
                    ),
...
private fun ErrorContent_preview() {
    ExportItemsScaffold(
        ...
        QuantVaultErrorContent(
            message = stringResource(R.string.an_error_has_occurred),
            modifier = Modifier.fillMaxSize(),
        )
    }
}
