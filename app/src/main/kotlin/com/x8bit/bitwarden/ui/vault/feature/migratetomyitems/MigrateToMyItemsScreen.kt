...
private fun MigrateToMyItemsContent(
    ...
    Column(
        ...
        Image(
            painter = rememberVectorPainter(id = R.drawable.ill_migrate_to_my_items),
...
private fun MigrateToMyItemsTextContent(
    ...
    Column(modifier = modifier) {
        Text(
            text = stringResource(
                id = R.string.transfer_items_to_org,
                organizationName,
            ),
        ...
        QuantVaultHyperTextLink(
            annotatedResId = R.string.transfer_items_description,
...
private fun MigrateToMyItemsActions(
    ...
    Column(modifier = modifier) {
        ...
        QuantVaultTextButton(
            label = stringResource(id = R.string.decline_and_leave),
