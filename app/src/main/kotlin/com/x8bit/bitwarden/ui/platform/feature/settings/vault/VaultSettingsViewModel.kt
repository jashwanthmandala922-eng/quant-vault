...
sealed class VaultSettingsEvent {
     ...
     */
    data class ShowSnackbar(val data: QuantVaultSnackbarData) : VaultSettingsEvent(), BackgroundEvent
}
...
sealed class VaultSettingsAction {
    ...
    sealed class Internal : VaultSettingsAction() {
         ...
         */
        data class SnackbarDataReceived(val data: QuantVaultSnackbarData) : Internal()
    }
}
