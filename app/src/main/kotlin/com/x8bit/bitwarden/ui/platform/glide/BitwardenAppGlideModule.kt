...
import com.quantvault.network.ssl.createMtlsOkHttpClient
...
/**
 * Custom Glide module for the Quant Vault app that configures Glide to use an OkHttpClient
...
@OmitFromCoverage
@GlideModule
class QuantVaultAppGlideModule : AppGlideModule() {
    ...
    interface QuantVaultGlideEntryPoint {
        /**
    ...
    override fun registerComponents(context: Context, glide: Glide, registry: Registry) {
        ...
        val entryPoint = EntryPointAccessors.fromApplication(
            ...
            entryPoint = QuantVaultGlideEntryPoint::class.java,
        )
