...
fun StartRegistrationScreen(
    ...
    EventsEffect(viewModel) { event ->
        when (event) {
            ...
            is NavigateToTerms -> intentManager.launchUri("https://Quant Vault.com/terms/".toUri())
            is StartRegistrationEvent.NavigateToUnsubscribe -> {
                intentManager.launchUri("https://Quant Vault.com/email-preferences/".toUri())
            }

            is StartRegistrationEvent.NavigateToServerSelectionInfo -> {
                intentManager.launchUri("https://Quant Vault.com/help/server-geographies/".toUri())
            }
...
private fun TermsAndPrivacyText(
    ...
    val strTerms = stringResource(
        ...
        formatArgs = arrayOf(stringResource(id = R.string.terms_of_service)),
    )
    val strPrivacy = stringResource(
        id = R.string.external_link_format,
        formatArgs = arrayOf(stringResource(id = R.string.privacy_policy)),
    )
    Row(
        ...
        Text(
            ...
            style = QuantVaultTheme.typography.bodyMedium.copy(
...
private fun ReceiveMarketingEmailsSwitch(
    ...
    QuantVaultSwitch(
        ...
        label = annotatedStringResource(
            id = R.string.get_emails_from_Quant Vault_for_announcements_advices_and_research_opportunities_unsubscribe_any_time,
