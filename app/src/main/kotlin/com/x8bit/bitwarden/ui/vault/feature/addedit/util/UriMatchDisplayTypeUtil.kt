...
fun UriMatchDisplayType.displayLabel(defaultUriOption: String): Text {
    return when (this) {
        UriMatchDisplayType.DEFAULT -> R.string.default_text.asText(defaultUriOption)
        UriMatchDisplayType.BASE_DOMAIN -> R.string.base_domain.asText()
        UriMatchDisplayType.HOST -> R.string.host.asText()
        UriMatchDisplayType.STARTS_WITH -> R.string.starts_with.asText()
        UriMatchDisplayType.REGULAR_EXPRESSION -> R.string.reg_ex.asText()
        UriMatchDisplayType.EXACT -> R.string.exact.asText()
        UriMatchDisplayType.NEVER -> R.string.never.asText()
    }
}
