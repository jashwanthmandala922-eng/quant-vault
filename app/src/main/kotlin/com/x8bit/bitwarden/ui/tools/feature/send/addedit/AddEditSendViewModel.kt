        ...
        when (val result = action.result) {
            ...
            is UpdateSendResult.Success -> {
                ...
                snackbarRelayManager.sendSnackbarData(
                    data = QuantVaultSnackbarData(message = R.string.send_updated.asText()),
                ...
                sendEvent(
                    AddEditSendEvent.ShowSnackbar(
                        data = QuantVaultSnackbarData(
                            message = R.string.password_removed.asText(),
                        ),
                    ),
                )
            }
                    ...
                    mutableStateFlow.update {
                        it.copy(
                            dialogState = AddEditSendState.DialogState.Error(
                                ...
                                message = R.string.one_or_more_email_addresses_are_incorrect
                                    .asText(),
                            ),
                        )
                    }
