...
import com.bitwarden.ui.platform.components.snackbar.QuantVaultSnackbar
    ...
    QuantVaultScaffold(
        ...
        Column(
            ...
            when (val viewState = state.viewState) {
                ...
                is VaultState.ViewState.Loading -> QuantVaultLoadingContent(
                    modifier = Modifier.fillMaxSize(),
                )
                ...
                is VaultState.ViewState.NoItems -> {
                    ...
                    VaultNoItems(
                        vectorRes = R.drawable.ill_vault_items,
                        headerText = stringResource(
                            id = R.string.save_and_protect_your_data,
                        ),
                ...
                is VaultState.ViewState.Error -> QuantVaultErrorContent(
...
private fun VaultDialogs(
    ...
    when (dialogState) {
        ...
        is VaultState.DialogState.Syncing -> QuantVaultLoadingDialog(
            text = stringResource(id = R.string.syncing),
        )

        is VaultState.DialogState.Error -> QuantVaultBasicDialog(
        ...
        is VaultState.DialogState.ThirdPartyBrowserAutofill -> {
            QuantVaultTwoButtonDialog(
                title = stringResource(
                    id = R.string.enable_browser_autofill_to_keep_filling_passwords,
                ),
                message = stringResource(
                    id = R.string.your_browser_recently_updated_how_autofill_works_singular,
                ),
        ...
        is VaultState.DialogState.VaultLoadCipherDecryptionError -> {
            QuantVaultTwoButtonDialog(
                ...
                message = pluralStringResource(
                    id = R.plurals.Quant Vault_could_not_decrypt_x_vault_item_copy_and_share_description_long,
