...
private fun ColumnScope.SetupUnlockHeaderCompact() {
    ...
    Image(
        painter = rememberVectorPainter(id = R.drawable.ill_account_setup),
...
private fun SetupUnlockScreenDialogs(
    ...
    when (dialogState) {
        is SetupUnlockState.DialogState.Loading -> QuantVaultLoadingDialog(
            text = dialogState.title(),
        )

        is SetupUnlockState.DialogState.Error -> QuantVaultBasicDialog(
