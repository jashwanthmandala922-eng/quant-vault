...
sealed class SendAuth : Parcelable {
    ...
    data object None : SendAuth() {
        override val text: Text
            get() = R.string.anyone_with_the_link.asText()

        override val supportingText: Text
            get() = R.string.anyone_with_link_can_view_send.asText()
    }
    ...
    data class Email(
        ...
        override val text: Text
            get() = R.string.specific_people.asText()

        override val supportingText: Text
            get() = R.string.specific_people_verification_info.asText()
    }
    ...
    data object Password : SendAuth() {
        override val text: Text
            get() = R.string.anyone_with_password.asText()
