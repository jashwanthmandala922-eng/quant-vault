        ...
        when (event) {
            ...
            SetupBrowserAutofillEvent.NavigateToBrowserIntegrationsInfo -> {
                intentManager.launchUri(
                    "https://Quant Vault.com/help/auto-fill-android/#browser-integrations/".toUri(),
                )
            }
        }
    }
...
private fun SetupBrowserAutofillContent(
    ...
    Column(
        ...
        Text(
            text = stringResource(id = R.string.turn_on_browser_autofill_integration),
        ...
        Text(
            text = stringResource(
                id = if (state.browserCount > 1) {
                    R.string.youre_using_a_browser_that_requires_special_permissions_plural
                } else {
                    R.string.youre_using_a_browser_that_requires_special_permissions_singular
                },
            ),
        ...
        QuantVaultClickableText(
            label = stringResource(id = R.string.why_is_this_step_required),
    ...
    when (dialogState) {
        SetupBrowserAutofillState.DialogState.TurnOnLaterDialog -> {
            QuantVaultTwoButtonDialog(
                title = stringResource(R.string.turn_on_browser_autofill_integration_later),
