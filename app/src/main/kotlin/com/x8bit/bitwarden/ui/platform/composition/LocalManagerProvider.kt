...
import com.quantvault.cxf.importer.dsl.credentialExchangeImporter
import com.quantvault.cxf.manager.CredentialExchangeCompletionManager
import com.quantvault.cxf.manager.dsl.credentialExchangeCompletionManager
...
import com.quantvault.cxf.ui.composition.LocalCredentialExchangeRequestValidator
import com.quantvault.cxf.validator.CredentialExchangeRequestValidator
import com.quantvault.cxf.validator.dsl.credentialExchangeRequestValidator
...
import com.x8bit.bitwarden.ui.platform.manager.QuantVaultBuildInfoManagerImpl
...
fun LocalManagerProvider(
    ...
    buildInfoManager: BuildInfoManager = QuantVaultBuildInfoManagerImpl(),
