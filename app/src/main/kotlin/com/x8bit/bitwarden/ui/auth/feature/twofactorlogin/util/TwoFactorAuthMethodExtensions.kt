...
val TwoFactorAuthMethod.imageRes: Int?
    get() = when (this) {
        TwoFactorAuthMethod.YUBI_KEY -> R.drawable.ill_yubi_key
        TwoFactorAuthMethod.EMAIL -> R.drawable.ill_new_device_verification
        TwoFactorAuthMethod.AUTHENTICATOR_APP -> R.drawable.ill_authenticator
        else -> null
    }
