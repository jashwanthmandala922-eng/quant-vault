...
fun VaultData.toViewState(
    ...
    return if (allCipherViews.isEmpty()) {
        ...
        VaultState.ViewState.Content(
            ...
            archiveEndIcon = R.drawable.ic_locked.takeIf { !isPremium && archiveCount == 0 },
            archiveSubText = R.string.premium_subscription_required
                .asText()
    ...
    return when (type) {
        is CipherListViewType.Login -> VaultState.ViewState.VaultItem.Login(
            ...
            name = if (hasDecryptionError) {
                R.string.error_cannot_decrypt.asText()
            } else {
                name.asText()
            },
