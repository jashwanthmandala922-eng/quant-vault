...
import com.bitwarden.ui.platform.components.appbar.QuantVaultSearchTopAppBar
...
fun SearchScreen(
    ...
    QuantVaultScaffold(
        ...
        when (val viewState = state.viewState) {
            ...
            is SearchState.ViewState.Error -> QuantVaultErrorContent(
                message = viewState.message(),
                modifier = Modifier
                    .fillMaxSize(),
            )

            SearchState.ViewState.Loading -> QuantVaultLoadingContent(
                modifier = Modifier
                    .fillMaxSize(),
            )
        }
...
private fun SearchDialogs(
    ...
    when (dialogState) {
        ...
        is SearchState.DialogState.Error -> QuantVaultBasicDialog(
        ...
        is SearchState.DialogState.Loading -> QuantVaultLoadingDialog(
