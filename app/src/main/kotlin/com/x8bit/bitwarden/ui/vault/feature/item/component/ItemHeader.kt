    ...
    item {
        Row(
            ...
            QuantVaultTextField(
                ...
                cardStyle = null,
                textStyle = QuantVaultTheme.typography.titleMedium,
            )
        }
    }
    ...
    if (isArchived) {
        item(key = "archiveItem") {
            ItemLocationListItem(
                vectorPainter = rememberVectorPainter(id = R.drawable.ic_archive),
    ...
    Box(
        ...
        modifier = modifier.then(
            if (applyBackgroundFill) {
                Modifier.background(
                    color = QuantVaultTheme.colorScheme.illustration.backgroundPrimary,
                    shape = QuantVaultTheme.shapes.favicon,
                )
            } else {
                Modifier
            },
        ...
        QuantVaultIcon(
            ...
            tint = if (applyBackgroundFill) {
                QuantVaultTheme.colorScheme.illustration.outline
            } else {
                Color.Unspecified
            },
            modifier = Modifier
