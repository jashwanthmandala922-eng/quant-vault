...
class ReviewExportViewModel @Inject constructor(
    ...
    private fun handleImportItemsClicked() {
        showLoadingDialog(message = R.string.exporting_items.asText())
    ...
    private fun handleVaultDataLoading() {
        showLoadingDialog(R.string.loading_vault_data.asText())
    }
    ...
    private fun showLoadingDialog(message: Text = R.string.loading.asText()) {
        mutableStateFlow.update {
            it.copy(
