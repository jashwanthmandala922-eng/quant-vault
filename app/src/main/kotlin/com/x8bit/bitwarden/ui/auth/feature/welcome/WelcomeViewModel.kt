...
data class WelcomeState(
    ...
    sealed class WelcomeCard : Parcelable {
        ...
        data object CardOne : WelcomeCard() {
            override val imageRes: Int get() = R.drawable.ill_vault_items
        ...
        data object CardTwo : WelcomeCard() {
            override val imageRes: Int get() = R.drawable.ill_welcome_2
        ...
        data object CardThree : WelcomeCard() {
            override val imageRes: Int get() = R.drawable.ill_welcome_3
        ...
        data object CardFour : WelcomeCard() {
            override val imageRes: Int get() = R.drawable.ill_welcome_4
