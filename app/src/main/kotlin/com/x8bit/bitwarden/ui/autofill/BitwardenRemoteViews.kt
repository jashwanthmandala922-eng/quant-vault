...
import com.bitwarden.ui.platform.theme.color.lightQuantVaultColorScheme
...
fun buildVaultItemAutofillRemoteViews(
    ...
    buildAutofillRemoteViews(
        ...
        iconRes = R.drawable.logo_Quant Vault_icon,
...
private val Context.QuantVaultColorScheme: QuantVaultColorScheme
    get() = if (isSystemDarkMode) darkQuantVaultColorScheme else lightQuantVaultColorScheme

val Context.iconTint: Color get() = QuantVaultColorScheme.icon.primary
private val Context.primaryText: Color get() = QuantVaultColorScheme.text.primary
private val Context.secondaryText: Color get() = QuantVaultColorScheme.text.secondary
private val Context.background: Color get() = QuantVaultColorScheme.background.primary
