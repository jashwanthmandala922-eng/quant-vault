...
import com.x8bit.bitwarden.ui.platform.components.util.rememberQuantVaultNavController
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            val navController = rememberQuantVaultNavController(name = "MainActivity")
            ...
            LocalManagerProvider(
                ...
                QuantVaultTheme(
                    ...
                    NavHost(
                        ...
                        modifier = Modifier
                            .background(color = QuantVaultTheme.colorScheme.background.primary),
                    ) {
