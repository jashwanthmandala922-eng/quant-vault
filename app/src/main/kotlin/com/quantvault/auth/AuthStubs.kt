...
class AuthRequestResponse(val publicKey: String = "", val accessCode: String = "", val fingerprint: String = "")
class KeyConnectorResponse(val url: String = "", val token: String = "")
class MasterPasswordPolicyOptions(val minLength: Int = 0, val requireUppercase: Boolean = false, val requireLowercase: Boolean = false, val requireNumbers: Boolean = false, val requireSpecial: Boolean = false)
class RegisterKeyResponse(val userId: String = "", val masterPasswordHash: String = "")
class RegisterTdeKeyResponse(val organizationId: String = "", val key: String = "")
...
class FingerprintRequest(val fingerprint: String = "", val fingerprintMaterial: String? = null, val publicKey: String = "")
...
data class InitUserCryptoResult(val userId: String, val userKey: ByteArray, val masterKey: ByteArray, val masterKeyHash: String, val privateKey: ByteArray?, val userPrivateKey: ByteArray?, val userPublicKey: ByteArray?, val keys: Keys?) {
...
class MasterPasswordAuthenticationData(
    ...
    val salt: String = "",
    val masterKeyWrappedUserKey: String? = null
)
...
sealed class WrappedAccountCryptographicState {
    ...
    abstract val userKey: ByteArray?
    abstract val userKeyWrappedUserKey: String?
    ...
    class V1(
        ...
        override val userKey: ByteArray? = null,
        override val userKeyWrappedUserKey: String? = null
...
data class AccountCryptographicState(val userKey: ByteArray, val masterKey: ByteArray, val masterKeyHash: String) { override fun equals(o: Any?) = false; override fun hashCode() = 0 }
...
class DeriveKeyConnectorResult(
    ...
    val keys: Keys?,
    val userKey: ByteArray? = null
) {
    class Keys(val userKey: ByteArray, val masterKey: ByteArray)
}

class UpdateKdfResponse(val userId: String, val masterPasswordAuthenticationData: MasterPasswordAuthenticationData? = null, val oldMasterPasswordAuthenticationData: MasterPasswordAuthenticationData? = null, val masterPasswordUnlockData: MasterPasswordUnlockData? = null)

class KeyConnectorCryptoAlgorithm { companion object { const val V1 = "v1"; const val V2 = "v2" } }

class IdentityTokenRequest(val grantType: String, val clientId: String, val deviceType: String = "android", val deviceIdentifier: String = "", val username: String = "", val password: String = "", val refreshToken: String = "")