package com.quantvault.data.manager.flightrecorder
...
import com.quantvault.network.util.redactHostnamesInMessage
        ...
        runCatching {
            ...
            if (!logFile.exists()) {
                ...
                val serverInfo = StringBuilder()
                    .append(serverData?.server?.name ?: "quantvault Cloud")
                    .apply {
                ...
                BufferedWriter(FileWriter(logFile, true)).use { bw ->
                    bw.appendLine("quantvault Android - ${buildInfoManager.applicationName}")
