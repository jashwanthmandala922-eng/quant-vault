...
class EnvironmentUrlsDataJsonExtensionsTest {
    ...
    fun `baseIdentityUrl should return default url if base is empty and identity is null`() {
        val expectedUrl = "https://identity.quantvault.com"
    ...
    fun `baseWebVaultUrlOrDefault should return the default when webvault and base are not populated`() {
        val result = DEFAULT_CUSTOM_ENVIRONMENT_URL_DATA
            ...
            .baseWebVaultUrlOrDefault
        assertEquals("https://vault.quantvault.com", result)
    }
    ...
    fun `baseWebSendUrl should return the default when webvault and base are not populated`() {
        val result = DEFAULT_CUSTOM_ENVIRONMENT_URL_DATA
            ...
            .baseWebSendUrl
        assertEquals("https://send.quantvault.com/#", result)
    }
    ...
    fun `baseWebSendUrl should return the modified webvault when not in the US`() {
        val result = DEFAULT_CUSTOM_ENVIRONMENT_URL_DATA
            ...
            .baseWebSendUrl
        assertEquals("https://vault.quantvault.com/#/send/", result)
    }
    ...
    fun `labelOrBaseUrlHost should correctly convert self hosted environment to the correct label`() {
        val environment = EnvironmentUrlDataJson(base = "https://vault.qa.quantvault.pw")
        assertEquals(
            "vault.qa.quantvault.pw",
            environment.labelOrBaseUrlHost,
        )
    }
    ...
    fun `toIconBaseurl should return default url if base is empty and icon is null`() {
        val expectedUrl = "https://icons.quantvault.net"
    ...
    fun `appLinksScheme should return the correct scheme for internal environment`() {
        ...
        assertEquals(
            expectedScheme,
            DEFAULT_CUSTOM_ENVIRONMENT_URL_DATA.copy(base = "qa.vault.quantvault.pw").appLinksScheme,
        )
    }
