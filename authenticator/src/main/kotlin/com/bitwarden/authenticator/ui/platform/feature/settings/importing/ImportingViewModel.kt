...
class ImportingViewModel @Inject constructor(
    ...
    initialState = ImportState(importFileFormat = ImportFileFormat.QuantVault_JSON),
) {
        ...
        when (result) {
                ...
                mutableStateFlow.update {
                    it.copy(
                        dialogState = ImportState.DialogState.Error(
                            title = result.title ?: QuantVaultString.an_error_has_occurred.asText(),
                            message = result.message
                                ?: QuantVaultString.import_vault_failure.asText(),
                        ),
                    )
                }
            }
            ...
            ImportDataResult.Success -> {
                ...
                snackbarRelayManager.sendSnackbarData(
                    data = QuantVaultSnackbarData(message = QuantVaultString.import_success.asText()),
