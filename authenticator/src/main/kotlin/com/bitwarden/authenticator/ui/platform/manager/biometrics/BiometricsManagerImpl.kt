package com.quantvault.authenticator.ui.platform.manager.biometrics
...
class BiometricsManagerImpl(
    ...
    override fun promptBiometrics(
        ...
        val promptInfo = BiometricPrompt.PromptInfo.Builder()
            .setTitle(activity.getString(QuantVaultString.QuantVault_authenticator))
            .setDescription(activity.getString(QuantVaultString.device_verification))
