...
data class TutorialState(
    ...
    sealed class TutorialSlide : Parcelable {
        ...
        data object IntroSlide : TutorialSlide() {
            override val image: Int get() = QuantVaultDrawable.ill_authenticator
            override val title: Int get() = QuantVaultString.secure_your_accounts_with_QuantVault_authenticator
            override val message: Int get() = QuantVaultString.get_verification_codes_for_all_your_accounts
        }
        ...
        data object QrScannerSlide : TutorialSlide() {
            override val image: Int get() = QuantVaultDrawable.ill_lock
            override val title: Int get() = QuantVaultString.use_your_device_camera_to_scan_codes
            override val message: Int get() = QuantVaultString.scan_the_qr_code_in_your_2_step_verification_settings_for_any_account
        }
        ...
        data object UniqueCodesSlide : TutorialSlide() {
            override val image: Int get() = QuantVaultDrawable.ill_pin
            override val title: Int get() = QuantVaultString.sign_in_using_unique_codes
            override val message: Int get() = QuantVaultString.when_using_2_step_verification_youll_enter_your_username_and_password_and_a_code_generated_in_this_app
        }
    }
}
