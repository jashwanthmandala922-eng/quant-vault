package com.quantvault.authenticator.ui.authenticator.feature.navbar
...
import com.quantvault.authenticator.ui.authenticator.feature.itemlisting.ItemListingGraphRoute
import com.quantvault.authenticator.ui.authenticator.feature.itemlisting.ItemListingRoute
import com.quantvault.authenticator.ui.authenticator.feature.itemlisting.itemListingGraph
import com.quantvault.authenticator.ui.platform.feature.settings.SettingsGraphRoute
import com.quantvault.authenticator.ui.platform.feature.settings.SettingsRoute
import com.quantvault.authenticator.ui.platform.feature.settings.export.navigateToExport
import com.quantvault.authenticator.ui.platform.feature.settings.importing.navigateToImporting
import com.quantvault.authenticator.ui.platform.feature.settings.settingsGraph
import com.quantvault.ui.platform.base.util.EventsEffect
import com.quantvault.ui.platform.base.util.navigateToTabOrRoot
...
import com.quantvault.ui.platform.components.scaffold.model.ScaffoldNavigationData
import com.quantvault.ui.platform.resource.QuantVaultDrawable
import com.quantvault.ui.platform.resource.QuantVaultString
import com.quantvault.ui.platform.theme.RootTransitionProviders
import com.quantvault.ui.platform.util.toObjectNavigationRoute
...
sealed class AuthenticatorNavBarTab : NavigationItem, Parcelable {
    ...
    data object VerificationCodes : AuthenticatorNavBarTab() {
        override val iconResSelected get() = QuantVaultDrawable.ic_verification_codes_filled
        override val iconRes get() = QuantVaultDrawable.ic_verification_codes
        override val labelRes get() = QuantVaultString.verification_codes
    ...
    data object Settings : AuthenticatorNavBarTab() {
        override val iconResSelected get() = QuantVaultDrawable.ic_settings_filled
        override val iconRes get() = QuantVaultDrawable.ic_settings
        override val labelRes get() = QuantVaultString.settings
