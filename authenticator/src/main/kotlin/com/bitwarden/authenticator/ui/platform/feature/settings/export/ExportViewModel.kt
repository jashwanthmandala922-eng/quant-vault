...
import com.quantvault.authenticator.ui.platform.util.fileExtension
    ...
    private fun handleExportDataToUriResult(result: ExportDataResult) {
        when (result) {
                ...
                mutableStateFlow.update {
                    it.copy(
                        dialogState = ExportState.DialogState.Error(
                            ...
                            message = QuantVaultString.export_vault_failure.asText(),
                        ),
                    )
                }
            }
            ...
            is ExportDataResult.Success -> {
                ...
                sendEvent(ExportEvent.ShowSnackBar(QuantVaultString.export_success.asText()))
            }
        }
    }
}
...
data class ExportState(
    ...
    sealed class DialogState {
         ...
         */
        data class Loading(
            val message: Text = QuantVaultString.loading.asText(),
        ) : DialogState()
