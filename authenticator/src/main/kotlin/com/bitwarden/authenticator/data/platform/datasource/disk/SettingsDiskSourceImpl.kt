...
import com.quantvault.data.datasource.disk.BaseDiskSource
...
private const val HAS_USER_DISMISSED_DOWNLOAD_QuantVault_KEY =
    "hasUserDismissedDownloadQuantVaultCard"
private const val HAS_USER_DISMISSED_SYNC_WITH_QuantVault_KEY =
    "hasUserDismissedSyncWithQuantVaultCard"
private const val PREVIOUSLY_SYNCED_QuantVault_ACCOUNT_IDS_KEY =
    "previouslySyncedQuantVaultAccountIds"
...
class SettingsDiskSourceImpl(
    ...
    override var previouslySyncedQuantVaultAccountIds: Set<String>
        get() = getStringSet(
            key = PREVIOUSLY_SYNCED_QuantVault_ACCOUNT_IDS_KEY,
            default = emptySet(),
        ) ?: emptySet()
        set(value) {
            putStringSet(
    ...
    override var hasUserDismissedDownloadQuantVaultCard: Boolean?
        get() = getBoolean(HAS_USER_DISMISSED_DOWNLOAD_QuantVault_KEY)
        set(value) {
            putBoolean(HAS_USER_DISMISSED_DOWNLOAD_QuantVault_KEY, value)
        }

    override var hasUserDismissedSyncWithQuantVaultCard: Boolean?
        get() = getBoolean(HAS_USER_DISMISSED_SYNC_WITH_QuantVault_KEY)
        set(value) {
            putBoolean(HAS_USER_DISMISSED_SYNC_WITH_QuantVault_KEY, value)
        }
