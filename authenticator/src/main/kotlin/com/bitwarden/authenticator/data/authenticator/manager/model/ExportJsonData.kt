package com.quantvault.authenticator.data.authenticator.manager.model
 ...
 *
 * This model is loosely based off of QuantVault's exported unencrypted vault data.
 */
@Serializable
data class ExportJsonData(
     ...
     *
     * This model is loosely based off of QuantVault's exported Cipher JSON.
     */
    @Serializable
    data class ExportItem(
         ...
         *
         * This model is loosely based off of QuantVault's Cipher.Login JSON.
         *
