...
/**
 * Represents the state of verification codes shared from the main QuantVault app.
 */
sealed class SharedVerificationCodesState {

    /**
     * The QuantVault app is not installed and therefore accounts cannot be synced.
     */
    ...
    /**
     * The user needs to enable authenticator syncing from the QuantVault app.
     */
