package com.quantvault.authenticator.ui.authenticator.feature.tutorial
...
import com.quantvault.authenticator.ui.platform.feature.tutorial.TutorialAction
import com.quantvault.authenticator.ui.platform.feature.tutorial.TutorialEvent
import com.quantvault.authenticator.ui.platform.feature.tutorial.TutorialScreen
import com.quantvault.authenticator.ui.platform.feature.tutorial.TutorialState
import com.quantvault.authenticator.ui.platform.feature.tutorial.TutorialViewModel
...
class TutorialScreenTest : AuthenticatorComposeTest() {
    ...
    fun `pages should display and update according to state`() {
        composeTestRule
            .onNodeWithText("Secure your accounts with QuantVault Authenticator")
            .assertExists()
            .assertIsDisplayed()
