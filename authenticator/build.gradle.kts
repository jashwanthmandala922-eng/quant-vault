...
base {
    ...
    archivesName.set("com.quantvault.authenticator")
}
...
configure<ApplicationExtension> {
    namespace = "com.quantvault.authenticator"
    compileSdk {
        version = release(libs.versions.compileSdk.get().toInt())
    }

    defaultConfig {
        applicationId = "com.quantvault.authenticator"
        minSdk {
    ...
    buildTypes {
        debug {
            ...
            manifestPlaceholders["targetQuant VaultAppId"] = "com.quantvault.app.dev"
            @Suppress("MaxLineLength")
            buildConfigField(
                type = "com.quantvault.authenticatorbridge.manager.model.AuthenticatorBridgeConnectionType",
                name = "AUTHENTICATOR_BRIDGE_CONNECTION_TYPE",
                value = "com.quantvault.authenticatorbridge.manager.model.AuthenticatorBridgeConnectionType.DEV",
            )
        ...
        release {
            manifestPlaceholders["targetQuant VaultAppId"] = "com.quantvault.app"
            @Suppress("MaxLineLength")
            buildConfigField(
                type = "com.quantvault.authenticatorbridge.manager.model.AuthenticatorBridgeConnectionType",
                name = "AUTHENTICATOR_BRIDGE_CONNECTION_TYPE",
                value = "com.quantvault.authenticatorbridge.manager.model.AuthenticatorBridgeConnectionType.RELEASE",
            )
