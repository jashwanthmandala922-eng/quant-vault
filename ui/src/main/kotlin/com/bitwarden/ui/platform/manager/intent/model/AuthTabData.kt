package com.quantvault.ui.platform.manager.intent.model
...
sealed class AuthTabData {
    ...
    /**
     * A representation of a custom "quantvault" scheme callback.
     */
    data class CustomScheme(
        override val callbackUrl: String,
        override val callbackScheme: String = "quantvault",
    ) : AuthTabData()
