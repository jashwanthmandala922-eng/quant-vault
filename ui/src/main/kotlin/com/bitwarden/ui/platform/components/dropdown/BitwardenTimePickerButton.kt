...
import com.quantvault.ui.platform.components.dialog.quantvaultTimePickerDialog
 ...
 */
@Composable
fun quantvaultTimePickerButton(
    label: String,
    totalMinutes: Int,
...
fun quantvaultTimePickerButton(
    ...
    quantvaultTextSelectionButton(
        ...
        selectedOption = if (hours != 0 && minutes != 0) {
            ...
            stringResource(
                id = quantvaultString.hours_minutes_format,
                formatArgs = arrayOf(
                    pluralStringResource(
                        id = quantvaultPlurals.hours_format,
                        count = hours,
                        formatArgs = arrayOf(hours),
                    ),
                    pluralStringResource(
                        id = quantvaultPlurals.minutes_format,
                        count = minutes,
