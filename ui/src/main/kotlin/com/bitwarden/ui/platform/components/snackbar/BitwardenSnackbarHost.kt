...
import com.quantvault.ui.platform.components.snackbar.model.quantvaultSnackbarHostState

/**
 * A custom quantvault-themed snackbar.
 *
 * @param quantvaultHostState The state of this snackbar.
 ...
 */
@Composable
fun quantvaultSnackbarHost(
    quantvaultHostState: quantvaultSnackbarHostState,
    ...
    SnackbarHost(
        hostState = quantvaultHostState.snackbarHostState,
        modifier = modifier
            .windowInsetsPadding(insets = windowInsets)
            .consumeWindowInsets(insets = windowInsets),
    ) { snackbarData ->
        val message = snackbarData.visuals.message
        val currentCustomSnackbarData = quantvaultHostState.currentSnackbarData
        if (currentCustomSnackbarData?.key == message) {
            quantvaultSnackbar(
                quantvaultSnackbarData = currentCustomSnackbarData,
