...
/**
 * Represents a quantvault-styled password field that is completely hidden and non-interactable.
 *
 ...
 */
@Composable
fun quantvaultHiddenPasswordField(
    label: String?,
    value: String,
    cardStyle: CardStyle,
    ...
    CompositionLocalProvider(value = LocalTextToolbar provides quantvaultEmptyTextToolbar) {
        TextField(
            modifier = modifier
...
@Preview
@Composable
private fun quantvaultHiddenPasswordField_preview() {
    QuantVaultTheme {
        quantvaultHiddenPasswordField(
            label = "Label",
            value = "Password",
