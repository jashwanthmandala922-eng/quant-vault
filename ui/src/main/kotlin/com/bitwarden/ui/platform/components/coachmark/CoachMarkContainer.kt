...
import com.quantvault.ui.platform.components.coachmark.model.CoachMarkHighlightShape
import com.quantvault.ui.platform.components.coachmark.model.CoachMarkState
import com.quantvault.ui.platform.components.coachmark.model.rememberCoachMarkState
import com.quantvault.ui.platform.components.coachmark.scope.CoachMarkScope
import com.quantvault.ui.platform.components.coachmark.scope.CoachMarkScopeInstance
...
fun <T : Enum<T>> CoachMarkContainer(
    ...
    Box(
        ...
        if (boundedRectangle != Rect.Zero && isVisible) {
            val backgroundColor = QuantVaultTheme.colorScheme.background.scrim
            Box(
                modifier = Modifier
                    .pointerInput(Unit) {
                        detectTapGestures(
...
@Composable
@Suppress("LongMethod")
private fun quantvaultCoachMarkContainer_preview() {
    QuantVaultTheme {
        ...
        CoachMarkContainer(
            ...
            Column(
                modifier = Modifier
                    .background(QuantVaultTheme.colorScheme.background.primary)
                    .padding(top = 100.dp)
                ...
                Row(
                    ...
                    CoachMarkHighlight(
                        ...
                        quantvaultStandardIconButton(
                            painter = rememberVectorPainter(quantvaultDrawable.ic_puzzle),
