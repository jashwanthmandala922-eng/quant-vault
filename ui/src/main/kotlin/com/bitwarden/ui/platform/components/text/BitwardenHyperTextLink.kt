package com.quantvault.ui.platform.components.text
...
import com.quantvault.ui.platform.base.util.spanStyleOf
...
fun quantvaultHyperTextLink(
    ...
    style: TextStyle = QuantVaultTheme.typography.labelMedium,
    color: Color = QuantVaultTheme.colorScheme.text.secondary,
    isExternalLink: Boolean = false,
) {
    val formattedAccessibilityString = if (isExternalLink) {
        stringResource(
            id = quantvaultString.external_link_format,
            formatArgs = arrayOf(accessibilityString),
        )
    } else {
        accessibilityString
    }
            ...
            .semantics {
                customActions = listOf(
                    CustomAccessibilityAction(
                        label = formattedAccessibilityString,
                        action = {
                            onClick()
                            true
                        },
