package com.quantvault.ui.platform.components.coachmark.scope
...
import com.quantvault.ui.platform.components.tooltip.quantvaultToolTip
import com.quantvault.ui.platform.components.tooltip.model.quantvaultToolTipState
import com.quantvault.ui.platform.components.tooltip.model.rememberquantvaultToolTipState
...
internal class CoachMarkScopeInstance<T : Enum<T>>(
    ...
    override fun CoachMarkHighlight(
        ...
        val toolTipState = rememberquantvaultToolTipState(
    ...
    private fun CoachMarkHighlightInternal(
        ...
        toolTipState: quantvaultToolTipState = rememberquantvaultToolTipState(
            initialIsVisible = false,
            isPersistent = true,
        ),
        anchorContent: @Composable () -> Unit,
