...
import com.quantvault.ui.platform.base.util.lowercaseWithCurrentLocal
import com.quantvault.ui.platform.base.util.scrolledContainerBackground
...
import com.quantvault.ui.platform.components.account.dialog.quantvaultLogoutConfirmationDialog
import com.quantvault.ui.platform.components.account.dialog.quantvaultRemovalConfirmationDialog
import com.quantvault.ui.platform.components.account.model.AccountSummary
import com.quantvault.ui.platform.components.account.util.iconRes
import com.quantvault.ui.platform.components.account.util.iconTestTag
import com.quantvault.ui.platform.components.account.util.initials
import com.quantvault.ui.platform.components.account.util.supportingTextResOrNull
import com.quantvault.ui.platform.components.dialog.quantvaultSelectionDialog
import com.quantvault.ui.platform.components.dialog.row.quantvaultBasicDialogRow
import com.quantvault.ui.platform.components.divider.quantvaultHorizontalDivider
import com.quantvault.ui.platform.components.scrim.quantvaultAnimatedScrim
 ...
 * a scrim via a [quantvaultAnimatedScrim] to all content below it (but not above it). Additional
 * [quantvaultAnimatedScrim] may be manually placed over other components that might not be covered
 * by the internal one.
 *
...
fun quantvaultAccountSwitcher(
    ...
    when {
        ...
        removeConfirmationAccount != null -> {
            quantvaultRemovalConfirmationDialog(
    ...
    Row(
        ...
        Box(
            ...
            Icon(
                painter = rememberVectorPainter(
                    id = quantvaultDrawable.ic_account_initials_container,
                ),
        ...
        Icon(
            ...
            tint = when (accountSummary.status) {
                AccountSummary.Status.ACTIVE -> QuantVaultTheme.colorScheme.icon.secondary
                else -> QuantVaultTheme.colorScheme.icon.primary
            },
            modifier = Modifier
        ...
        selectionItems = {
            if (accountSummary.isVaultUnlocked) {
                quantvaultBasicDialogRow(
                    text = stringResource(id = quantvaultString.lock),
                    onClick = {
            ...
            if (accountSummary.isLoggedIn) {
                quantvaultBasicDialogRow(
                    text = stringResource(id = quantvaultString.log_out),
                    onClick = {
                ...
                quantvaultBasicDialogRow(
                    text = stringResource(id = quantvaultString.remove_account),
                    onClick = {
...
private fun AddAccountItem(
    ...
    Row(
        ...
        Icon(
            painter = rememberVectorPainter(id = quantvaultDrawable.ic_plus_small),
            contentDescription = null,
        ...
        Text(
            text = stringResource(id = quantvaultString.add_account),
...
@Composable
private fun quantvaultAccountSwitcher_preview() {
