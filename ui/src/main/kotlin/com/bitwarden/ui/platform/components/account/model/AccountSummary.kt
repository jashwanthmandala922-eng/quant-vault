package com.quantvault.ui.platform.components.account.model

import android.os.Parcelable
import androidx.compose.ui.graphics.Color
import com.quantvault.ui.platform.base.util.hexToColor
 ...
 * (ex: "quantvault.com"). This is purely for display purposes.
 * @property isActive Whether the account is currently the active one.
 * @property isVaultUnlocked Whether the account's vault is currently unlocked.
 */
@Parcelize
