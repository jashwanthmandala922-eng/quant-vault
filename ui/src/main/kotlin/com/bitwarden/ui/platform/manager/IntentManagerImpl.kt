package com.quantvault.ui.platform.manager
...
import com.quantvault.core.data.manager.util.fileProviderAuthority
import com.quantvault.core.util.isBuildVersionAtLeast
import com.quantvault.ui.platform.manager.intent.model.AuthTabData
import com.quantvault.ui.platform.model.FileData
import com.quantvault.ui.platform.resource.quantvaultString
import com.quantvault.ui.platform.util.getLocalFileData
    ...
    override fun createFileChooserIntent(withCameraIntents: Boolean, mimeType: String): Intent {
        val chooserIntent = Intent.createChooser(
            Intent(Intent.ACTION_OPEN_DOCUMENT)
                ...
                .setType(mimeType),
            ContextCompat.getString(activity, quantvaultString.file_source),
        )
