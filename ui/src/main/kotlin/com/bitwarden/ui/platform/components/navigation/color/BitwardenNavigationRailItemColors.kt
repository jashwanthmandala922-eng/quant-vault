...
/**
 * Provides a default set of quantvault-styled colors for navigation rail items.
 */
@Composable
fun quantvaultNavigationRailItemColors(): NavigationRailItemColors = NavigationRailItemColors(
