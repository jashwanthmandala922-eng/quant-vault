package com.quantvault.ui.platform.components.tooltip
...
/**
 * quantvault themed rich tool-tip to show within a [TooltipScope].
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun TooltipScope.quantvaultToolTip(
    title: String,
    description: String,
    ...
    PlainTooltip(
        ...
        shape = QuantVaultTheme.shapes.coachmark,
            ...
            Row(
                ...
                onDismiss?.let {
                    quantvaultStandardIconButton(
                        painter = rememberVectorPainter(quantvaultDrawable.ic_close_small),
