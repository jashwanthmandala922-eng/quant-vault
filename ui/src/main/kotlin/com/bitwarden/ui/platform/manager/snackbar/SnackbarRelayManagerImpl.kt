...
import com.quantvault.core.data.repository.util.emitWhenSubscribedTo
...
class SnackbarRelayManagerImpl<T : Any>(
    ...
    override fun sendSnackbarData(data: quantvaultSnackbarData, relay: T) {
    ...
    override fun getSnackbarDataFlow(relay: T, vararg relays: T): Flow<quantvaultSnackbarData> =
        merge(
...
/**
 * A wrapper for the [quantvaultSnackbarData] payload and relay [T] associated with it.
 */
