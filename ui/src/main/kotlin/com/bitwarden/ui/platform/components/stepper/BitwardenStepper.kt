package com.quantvault.ui.platform.components.stepper
...
import com.quantvault.ui.platform.base.util.orNullIfBlank
import com.quantvault.ui.platform.components.button.quantvaultFilledIconButton
        ...
        supportingContent = supportingText?.let {
            {
                Text(
                    ...
                    color = quantvaultTextFieldColors().focusedSupportingTextColor,
...
fun quantvaultStepper(
    ...
    quantvaultTextField(
        ...
        actions = {
            quantvaultFilledIconButton(
                vectorIconRes = quantvaultDrawable.ic_minus,
                contentDescription = "\u2212",
                onClick = {
            ...
            quantvaultFilledIconButton(
                vectorIconRes = quantvaultDrawable.ic_plus,
                contentDescription = "+",
                onClick = {
