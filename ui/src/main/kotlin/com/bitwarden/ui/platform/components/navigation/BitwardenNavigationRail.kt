...
import com.quantvault.ui.platform.base.util.endDivider
...
/**
 * A custom quantvault-themed navigation rail.
 */
@Composable
fun quantvaultNavigationRail(
    ...
    Surface(
        color = QuantVaultTheme.colorScheme.background.secondary,
