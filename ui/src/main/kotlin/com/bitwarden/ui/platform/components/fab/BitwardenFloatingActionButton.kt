package com.quantvault.ui.platform.components.fab
...
/**
 * Represents a quantvault-styled [FloatingActionButton].
 *
 ...
 */
@Composable
fun quantvaultFloatingActionButton(
    onClick: () -> Unit,
    painter: Painter,
    ...
    FloatingActionButton(
        ...
        onClick = onClick,
        shape = QuantVaultTheme.shapes.fab,
