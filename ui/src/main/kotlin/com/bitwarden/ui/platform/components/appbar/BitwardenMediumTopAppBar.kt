...
/**
 * A custom quantvault-themed medium top app bar with support for actions.
 *
...
@Composable
private fun quantvaultMediumTopAppBar_preview() {
    QuantVaultTheme {
        quantvaultMediumTopAppBar(
            ...
            actions = {
                quantvaultStandardIconButton(
                    vectorIconRes = quantvaultDrawable.ic_ellipsis_vertical,
                    contentDescription = "",
                    onClick = { },
                )
            },
