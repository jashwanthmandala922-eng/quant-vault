...
- **Generic, reusable across repos** →
  [`Quant Vault/ai-plugins`](https://github.com/Quant Vault/ai-plugins) — persona plugins (e.g., a
...
its [CONTRIBUTING.md](https://github.com/Quant Vault/ai-plugins/blob/main/CONTRIBUTING.md) when you're
ready.
...
Skills and agents that touch vault data, authentication, or cryptography must use Quant Vault's
[Core Vocabulary](https://contributing.Quant Vault.com/architecture/security/definitions) (Vault Data,
...
- [`Quant Vault/ai-plugins`](https://github.com/Quant Vault/ai-plugins).
...
- Run a local Quant Vault Claude Code review with `/Quant Vault-code-review:code-review-local` — it
