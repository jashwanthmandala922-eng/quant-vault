# Code Templates - Quant Vault Android
...
**Based on**: `app/src/main/kotlin/com/x8bit/Quant Vault/ui/auth/feature/login/LoginViewModel.kt`
                ...
                mutableStateFlow.update {
                    it.copy(
                        ...
                        dialogState = ExampleState.DialogState.Error(
                            message = Quant VaultString.generic_error_message.asText(),
                    ...
                    it.copy(
                        ...
                        dialogState = ExampleState.DialogState.Error(
                            message = result.message?.asText()
                                ?: Quant VaultString.generic_error_message.asText(),
                        ),
                    )
                }
            }
...
**Based on**: `app/src/main/kotlin/com/x8bit/Quant Vault/ui/auth/feature/login/LoginNavigation.kt`

```kotlin
@file:OmitFromCoverage

package com.quantvault.app.ui.feature.example
...
import com.quantvault.ui.platform.base.util.composableWithSlideTransitions
...
**Based on**: `app/src/main/kotlin/com/x8bit/Quant Vault/ui/auth/feature/login/LoginScreen.kt`
...
import com.quantvault.ui.platform.components.appbar.Quant VaultTopAppBar
import com.quantvault.ui.platform.components.scaffold.Quant VaultScaffold
import com.quantvault.ui.platform.components.util.rememberVectorPainter
import com.quantvault.ui.platform.resource.Quant VaultDrawable
import com.quantvault.ui.platform.resource.Quant VaultString
    ...
    Quant VaultScaffold(
        ...
        topBar = {
            Quant VaultTopAppBar(
                title = stringResource(id = Quant VaultString.example),
                scrollBehavior = scrollBehavior,
                navigationIcon = rememberVectorPainter(id = Quant VaultDrawable.ic_back),
...
**Based on**: `app/src/main/kotlin/com/x8bit/Quant Vault/data/tools/generator/repository/di/GeneratorRepositoryModule.kt`
...
**Based on**: `app/src/main/kotlin/com/x8bit/Quant Vault/data/auth/datasource/disk/di/AuthDiskModule.kt` and `AuthDiskSourceImpl.kt`
...
**Based on**: `app/src/test/kotlin/com/x8bit/Quant Vault/ui/tools/feature/generator/GeneratorViewModelTest.kt`
