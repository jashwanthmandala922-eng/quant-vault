...
Quant Vault Android uses Turbine for testing Kotlin Flows, including the critical distinction between StateFlow and EventFlow patterns.
...
`app/src/test/kotlin/com/x8bit/Quant Vault/ui/tools/feature/generator/GeneratorViewModelTest.kt`

**Repository Flow Testing:**
`data/src/test/kotlin/com/Quant Vault/data/tools/generator/repository/GeneratorRepositoryTest.kt`

**Complex Flow Transformations:**
`data/src/test/kotlin/com/Quant Vault/data/vault/repository/VaultRepositoryTest.kt`
