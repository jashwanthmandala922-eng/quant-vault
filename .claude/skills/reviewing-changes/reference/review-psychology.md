...
**Example**:
```
**app/login/LoginScreen.kt:89** - Consider using existing Quant VaultButton

This custom button implementation looks similar to `ui/components/Quant VaultButton.kt:45`.
